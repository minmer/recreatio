...
IF OBJECT_ID(N'forms.FormAnswers', N'U') IS NOT NULL DROP TABLE forms.FormAnswers;
IF OBJECT_ID(N'forms.FormQuestions', N'U') IS NOT NULL DROP TABLE forms.FormQuestions;
IF OBJECT_ID(N'forms.FormResponses', N'U') IS NOT NULL DROP TABLE forms.FormResponses;
IF OBJECT_ID(N'forms.Forms', N'U') IS NOT NULL DROP TABLE forms.Forms;
...
IF OBJECT_ID(N'rowerowa.RowerowaRegistrations', N'U') IS NOT NULL DROP TABLE rowerowa.RowerowaRegistrations;
IF OBJECT_ID(N'rowerowa.RowerowaEvents', N'U') IS NOT NULL DROP TABLE rowerowa.RowerowaEvents;
...
IF OBJECT_ID(N'hortus.HortusReservationStatusLogs', N'U') IS NOT NULL DROP TABLE hortus.HortusReservationStatusLogs;
IF OBJECT_ID(N'hortus.HortusReservationItems', N'U') IS NOT NULL DROP TABLE hortus.HortusReservationItems;
IF OBJECT_ID(N'hortus.HortusReservations', N'U') IS NOT NULL DROP TABLE hortus.HortusReservations;
IF OBJECT_ID(N'hortus.HortusResources', N'U') IS NOT NULL DROP TABLE hortus.HortusResources;
IF OBJECT_ID(N'hortus.HortusPlaces', N'U') IS NOT NULL DROP TABLE hortus.HortusPlaces;
...
IF OBJECT_ID(N'dbo.CogitaStoryboardSessionAnswers', N'U') IS NOT NULL DROP TABLE dbo.CogitaStoryboardSessionAnswers;
IF OBJECT_ID(N'dbo.CogitaStoryboardSessionParticipants', N'U') IS NOT NULL DROP TABLE dbo.CogitaStoryboardSessionParticipants;
IF OBJECT_ID(N'dbo.CogitaStoryboardSessions', N'U') IS NOT NULL DROP TABLE dbo.CogitaStoryboardSessions;
...
IF OBJECT_ID(N'dbo.ParishConfirmationEventJoins', N'U') IS NOT NULL DROP TABLE dbo.ParishConfirmationEventJoins;
IF OBJECT_ID(N'dbo.ParishConfirmationEvents', N'U') IS NOT NULL DROP TABLE dbo.ParishConfirmationEvents;
...
(
    ...
    YearSummaryCompleteTemplate NVARCHAR(MAX) NOT NULL CONSTRAINT DF_ParishConfirmationSmsTemplates_YearSummaryCompleteTemplate DEFAULT N'',
    YearSummaryIncompleteTemplate NVARCHAR(MAX) NOT NULL CONSTRAINT DF_ParishConfirmationSmsTemplates_YearSummaryIncompleteTemplate DEFAULT N'',
    CreatedUtc DATETIMEOFFSET NOT NULL,
    UpdatedUtc DATETIMEOFFSET NOT NULL,
...
(
    ...
    PaperIndexChecked BIT NOT NULL CONSTRAINT DF_ParishConfirmationCandidates_PaperIndexChecked DEFAULT 0,
    QuizCompleted BIT NOT NULL CONSTRAINT DF_ParishConfirmationCandidates_QuizCompleted DEFAULT 0,
    CreatedUtc DATETIMEOFFSET NOT NULL,
    UpdatedUtc DATETIMEOFFSET NOT NULL,
...
(
    ...
    StorageProvider NVARCHAR(32) NULL,
    StoragePath NVARCHAR(512) NULL,
    StorageSizeBytes BIGINT NULL,
    StorageSha256 VARBINARY(32) NULL,
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'CogitaStoryboardSessions' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
    ...
    (
        ...
        CreatedUtc DATETIMEOFFSET NOT NULL,
        RevokedUtc DATETIMEOFFSET NULL,
        CONSTRAINT FK_CogitaStoryboardSessions_Library FOREIGN KEY (LibraryId) REFERENCES dbo.CogitaLibraries(Id),
        CONSTRAINT FK_CogitaStoryboardSessions_Project FOREIGN KEY (ProjectId) REFERENCES dbo.CogitaCreationProjects(Id),
        CONSTRAINT FK_CogitaStoryboardSessions_OwnerRole FOREIGN KEY (OwnerRoleId) REFERENCES dbo.Roles(Id)
    );
END
GO
...
BEGIN
    CREATE INDEX IX_CogitaStoryboardSessions_Library_Project_Revoked
        ON dbo.CogitaStoryboardSessions(LibraryId, ProjectId, RevokedUtc, CreatedUtc DESC);
END
GO
...
BEGIN
    CREATE UNIQUE INDEX UX_CogitaStoryboardSessions_PublicCodeHash
        ON dbo.CogitaStoryboardSessions(PublicCodeHash);
END
GO

IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'CogitaStoryboardSessionParticipants' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
    ...
    (
        ...
        UpdatedUtc DATETIMEOFFSET NOT NULL,
        CONSTRAINT FK_CogitaStoryboardSessionParticipants_Session FOREIGN KEY (SessionId) REFERENCES dbo.CogitaStoryboardSessions(Id)
    );
END
GO
...
BEGIN
    CREATE UNIQUE INDEX UX_CogitaStoryboardSessionParticipants_SessionToken
        ON dbo.CogitaStoryboardSessionParticipants(SessionId, JoinTokenHash);
END
GO
...
BEGIN
    ...
    (
        ...
        AttemptCount INT NOT NULL CONSTRAINT DF_CogitaStoryboardSessionAnswers_AttemptCount DEFAULT (1),
        FirstSubmittedUtc DATETIMEOFFSET NOT NULL,
        UpdatedUtc DATETIMEOFFSET NOT NULL,
        CONSTRAINT FK_CogitaStoryboardSessionAnswers_Session FOREIGN KEY (SessionId) REFERENCES dbo.CogitaStoryboardSessions(Id),
        CONSTRAINT FK_CogitaStoryboardSessionAnswers_Participant FOREIGN KEY (ParticipantId) REFERENCES dbo.CogitaStoryboardSessionParticipants(Id)
    );
END
GO
...
BEGIN
    CREATE UNIQUE INDEX UX_CogitaStoryboardSessionAnswers_SessionParticipantNode
        ON dbo.CogitaStoryboardSessionAnswers(SessionId, ParticipantId, NodeKey);
END
GO
...
BEGIN
    CREATE INDEX IX_CogitaStoryboardSessionAnswers_SessionNode
        ON dbo.CogitaStoryboardSessionAnswers(SessionId, NodeKey);
END
GO
...
-- Calendar module
-- Adds shared calendar tables in dedicated [calendar] schema.
...
BEGIN
    CREATE INDEX IX_Calendars_UpdatedUtc
        ON calendar.Calendars(UpdatedUtc);
END
GO
...
BEGIN
    CREATE INDEX IX_Calendars_OrganizationUpdated
        ON calendar.Calendars(OrganizationScope, UpdatedUtc);
END
GO
...
BEGIN
    CREATE INDEX IX_CalendarRoleBindings_CalendarRevoked
        ON calendar.CalendarRoleBindings(CalendarId, RevokedUtc);
END
GO
...
BEGIN
    CREATE INDEX IX_CalendarRoleBindings_RoleRevoked
        ON calendar.CalendarRoleBindings(RoleId, RevokedUtc);
END
GO
...
BEGIN
    CREATE INDEX IX_CalendarEvents_CalendarStart
        ON calendar.CalendarEvents(CalendarId, StartUtc);
END
GO
...
BEGIN
    CREATE INDEX IX_CalendarEvents_CalendarStatusStart
        ON calendar.CalendarEvents(CalendarId, Status, StartUtc);
END
GO
...
BEGIN
    CREATE INDEX IX_CalendarEvents_CalendarLinkedEntity
        ON calendar.CalendarEvents(CalendarId, LinkedModule, LinkedEntityType, LinkedEntityId);
END
GO
...
BEGIN
    CREATE INDEX IX_CalendarEventRoleScopes_EventRevoked
        ON calendar.CalendarEventRoleScopes(EventId, RevokedUtc);
END
GO
...
BEGIN
    CREATE INDEX IX_CalendarEventRoleScopes_RoleRevoked
        ON calendar.CalendarEventRoleScopes(RoleId, RevokedUtc);
END
GO
...
BEGIN
    CREATE INDEX IX_CalendarEventReminders_EventStatus
        ON calendar.CalendarEventReminders(EventId, Status);
END
GO
...
-- Rowerowa Czestochowa event module
-- Dedicated tables in separate [rowerowa] schema, distinct from pilgrimage/edk data.
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'RowerowaEvents' AND schema_id = SCHEMA_ID('rowerowa'))
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'RowerowaRegistrations' AND schema_id = SCHEMA_ID('rowerowa'))
BEGIN
    ...
    (
        ...
        CreatedUtc DATETIMEOFFSET NOT NULL,
        UpdatedUtc DATETIMEOFFSET NOT NULL,
        CONSTRAINT FK_RowerowaRegistrations_Event FOREIGN KEY (EventId) REFERENCES rowerowa.RowerowaEvents(Id)
    );
END
GO

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_RowerowaRegistrations_EventCreated' AND object_id = OBJECT_ID('rowerowa.RowerowaRegistrations'))
BEGIN
    CREATE INDEX IX_RowerowaRegistrations_EventCreated ON rowerowa.RowerowaRegistrations(EventId, CreatedUtc);
END
GO
...
/*
  Runtime compatibility: ensure CogitaStoryboardSessions runtime tracking tables.
*/
...
-- Dedicated tables in separate [forms] schema.
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'Forms' AND schema_id = SCHEMA_ID('forms'))
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'FormQuestions' AND schema_id = SCHEMA_ID('forms'))
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'FormResponses' AND schema_id = SCHEMA_ID('forms'))
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_FormResponses_FormId_SubmittedUtc' AND object_id = OBJECT_ID('forms.FormResponses'))
BEGIN
    CREATE INDEX IX_FormResponses_FormId_SubmittedUtc ON forms.FormResponses(FormId, SubmittedUtc);
END
GO

IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'FormAnswers' AND schema_id = SCHEMA_ID('forms'))
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_FormAnswers_QuestionId' AND object_id = OBJECT_ID('forms.FormAnswers'))
BEGIN
...
-- Dedicated tables in a separate [hortus] schema; see also Sql/patch_hortus.sql.
