...
public static class Token
{
    ...
    /// ausschliesslich <see cref="TokenRecord.Hash"/>.
    /// </summary>
    public static (string Secret, TokenRecord Record) Create(
        ...
        string? label = null)
    {
        ...
        if (purpose == TokenPurpose.SmsAccessLink && lifetime < MinimumSmsLifetime)
    ...
    /// </summary>
    public static bool Verify(TokenRecord record, string presentedSecret, DateTimeOffset now)
    {
