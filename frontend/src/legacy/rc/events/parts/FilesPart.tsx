      ...
      <ListEditor<FileEntry>
        ...
        renderItem={(item, update) => (
          <>
            ...
            {/*
              HIER STAND DER HOCHLADEKNOPF.

              Im alten Modul lud er die Datei hoch und fuellte Adresse, Name und
              Groesse in einem Zug. Das rc-Modell hat noch keine Ablage fuer
              Anhaenge (die haengen bis heute an Nachrichten und brauchen erst
              einen allgemeinen Traeger), also gibt es hier nichts, worin die
              Datei landen koennte.

              Einen Knopf stehen zu lassen, der nichts tut, waere schlimmer als
              keiner: er sieht aus wie ein Weg. Die Adresse von Hand einzutragen
              geht, und das steht auch da.
            */}
            <TextRow
              label="Opis"
              value={item.note ?? ''}
