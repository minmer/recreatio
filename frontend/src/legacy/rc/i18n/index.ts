...
export interface RcCopy {
   ...
   *
   * Nur die Ueberschrift steht hier: die Seite selbst ist polnisch
   * geschrieben, wie alles, was nach dem Terminplan dazugekommen ist. In der
   * Leiste steht sie aber neben uebersetzten Namen, und ein einzelnes
   * fremdes Wort dazwischen sieht aus wie ein Fehler.
   */
  readonly workspace: {
    readonly heading: string;
  };
