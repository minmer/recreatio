...
import { RcWorkspace } from './RcWorkspace';
...
export function RcApp() {
  ...
  const parts = useMemo(
    () =>
      [
        /*
          DER ARBEITSPLATZ STEHT VORN.

          Er ist die Eingangshalle: von hier aus geht es weiter. Ihn hinten
          einzuordnen hiesse, dass man erst an sechs Zielen vorbeigeht, um
          zu dem zu kommen, das sie alle aufzaehlt.
        */
        ['workspace', t.workspace.heading],
      ...
      <div className="rc-root">
        <RcSignInPage
          ...
          /*
            ...
            Wer eine Adresse aufgerufen hat und stattdessen ein
            Anmeldeformular sieht, hat zwei Fragen: was ist mit meiner
            Adresse passiert, und komme ich danach dorthin zurueck. Beide
            werden hier beantwortet, statt ihn raten zu lassen.

            Das Einladungsband hat Vorrang: wer ueber einen Link kommt,
            soll zuerst lesen, wohin der fuehrt.
          */
          banner={inviteSecret !== null ? (
            <RcInviteBanner
              lang={lang}
              secret={inviteSecret}
              canRedeem={false}
            ...
            />
          ) : address.part === 'workspace' ? (
            <p className="rc-gate-note">
              Warsztat jest tym, do czego masz klucze — bez zalogowania nie ma
              tu czego pokazać. Po zalogowaniu wrócisz dokładnie tutaj.
            </p>
          ) : null}
        >
  ...
  return (
    <div className="rc-root">
      <div className="rc-shell">
        ...
        {/*
          Der Arbeitsplatz steht ALLEIN, wenn seine Adresse aufgerufen wird —
          nicht zusaetzlich auf der Startseite. Er zaehlt die anderen Teile
          auf; unter ihnen zu stehen und sie gleichzeitig aufzuzaehlen waere
          eine Seite, die auf sich selbst zeigt.
        */}
        {address.part === 'workspace' && <RcWorkspace />}
