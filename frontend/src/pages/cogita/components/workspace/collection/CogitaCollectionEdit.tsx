...
const COLLECTION_GRAPH_I18N = {
  en: {
    nodeLabels: {
      ...
      'source.info.all': 'All notions',
      'source.info': 'Notion source',
    ...
    selectedInfoNode: 'Selected notion',
    selectedInfosNode: 'Selected notions',
    draftLoaded: 'Draft loaded from {count} selected notions. Set name and save to create collection.'
  },
  pl: {
    nodeLabels: {
