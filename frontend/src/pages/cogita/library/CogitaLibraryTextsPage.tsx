      ...
      <section className="cogita-library-dashboard" data-mode="detail">
        <header className="cogita-library-dashboard-header">
          <div>
            ...
            <p className="cogita-library-subtitle">{copy.cogita.library.modules.textsSubtitle}</p>
          </div>
        </header>
            ...
            <div className="cogita-library-grid">
              <section className="cogita-library-detail">
                <div className="cogita-detail-header">
                  <h3 className="cogita-detail-title">{copy.cogita.library.modules.textsTitle}</h3>
                </div>
                <div className="cogita-detail-body">
                  <label className="cogita-field full">
                    <span>{copy.cogita.library.modules.textsNewLabel}</span>
                    <input
                      type="text"
                      value={name}
                      onChange={(event) => setName(event.target.value)}
                      placeholder={copy.cogita.library.modules.textsNewPlaceholder}
                    />
                  </label>
