...
const START_PATTERN_BANDS: Array<{ id: string; x: number; y: number; scale: number; tone: StoneTone; facetTone: StoneFacetTone }> = [
  { id: 'b1', x: -22, y: 10, scale: 7.35, tone: 'green', facetTone: 'green' },
  { id: 'b2', x: 8, y: 740, scale: 7.28, tone: 'yellow', facetTone: 'orange' },
  { id: 'b3', x: -26, y: 1470, scale: 7.32, tone: 'coral', facetTone: 'red' },
  { id: 'b4', x: 10, y: 2200, scale: 7.3, tone: 'orange', facetTone: 'red' },
  { id: 'b5', x: -20, y: 2930, scale: 7.34, tone: 'greenDark', facetTone: 'green' },
  { id: 'b6', x: 6, y: 3660, scale: 7.29, tone: 'yellow', facetTone: 'orange' },
  { id: 'b7', x: -24, y: 4390, scale: 7.36, tone: 'coral', facetTone: 'red' }
];
...
function PilgrimageStoneMap({
  ...
  return (
    ...
    >
      ...
      {START_PATTERN_BANDS.map((band) => (
        <g key={band.id} transform={`translate(${band.x} ${band.y}) scale(${band.scale})`}>
          <path d={BLACK_STONES_PATTERN_PATH} fill={STONE_FACET_COLORS[band.facetTone]} transform="translate(1.6 1.8)" />
          <path d={BLACK_STONES_PATTERN_PATH} fill={STONE_MAIN_COLORS[band.tone]} />
        </g>
      ))}
      {stones.map((stone) => (
        <g key={stone.id}>
