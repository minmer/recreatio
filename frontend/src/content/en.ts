    ...
    library: {
      ...
      revision: {
        ...
        live: {
          ...
          summaryEvaluationFlow: 'Round scoring is evaluated in stages: answer correctness first, then active bonuses are added, and the final round score is saved as an integer value.',
          summaryPointsTotalHint: 'With these settings, a typical gain per correct answer is usually around {min}–{max} points.',
          ...
          summaryActions: 'Action after first answer: {firstAction}. Action after all answered: {allAction}. Action on timer end: {expireAction}.',
