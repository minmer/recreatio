...
export const en: Copy = {
  ...
  account: {
    ...
    roles: {
      ...
      edgeTitle: 'Relation',
      linkDraftTitle: 'Draft link',
      linkDraftHint: 'UI preview only. Backend actions coming next.',
      createOwnedRole: 'Create owned role',
      createOwnedRoleHint: 'UI preview only. Owner will be the selected role.',
    ...
    persons: {
      ...
      dataEmpty: 'No personal data yet.',
      dataEdit: 'Edit',
      dataTypeLabel: 'Type',
      dataTypePlaceholder: 'name, birthday, etc.',
      dataValueLabel: 'Value',
      dataValuePlaceholder: 'Enter value',
      dataAction: 'Save data',
      dataWorking: 'Saving data…',
      ...
      accessEmpty: 'No shared roles yet.',
      pendingTitle: 'Pending shares',
      pendingAccept: 'Accept share',
      pendingWorking: 'Accepting share…',
      pendingSuccess: 'Share accepted.',
      pendingError: 'Could not accept share.',
      memberTitle: 'Share with role',
      lookupLabel: 'Find by nick',
      lookupPlaceholder: 'Enter role nick',
      lookupAction: 'Find role',
      lookupWorking: 'Searching roles…',
      lookupSuccess: 'Roles loaded.',
      lookupError: 'No roles found.',
      lookupMissing: 'Nick is required.',
      memberRoleLabel: 'Target role ID',
      memberRolePlaceholder: 'Paste role ID',
      memberTypeLabel: 'Access role',
      memberAction: 'Share role',
      memberWorking: 'Sharing role…',
      memberSuccess: 'Role shared.',
      memberError: 'Role share failed.',
      memberMissing: 'Role ID is required.',
      roleOwner: 'Owner',
      roleRead: 'Read',
      roleWrite: 'Write',
