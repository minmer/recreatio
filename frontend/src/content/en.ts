...
export const en: Copy = {
  ...
  account: {
    ...
    roles: {
      ...
      relationAdminOf: 'AdminOf — manage members and settings.',
      relationWrite: 'Write — can edit data, no membership control.',
      relationRead: 'Read — view only.',
      relationMemberOf: 'MemberOf — membership link.',
      relationDelegatedTo: 'DelegatedTo — delegated authority.',
      relationData: 'Data — encrypted field owned by the role.',
      relationRecoveryOwner: 'RecoveryOwner — role owns its recovery key.',
      relationRecoveryShare: 'RecoveryShare — shared recovery node.',
      relationRecoveryAccess: 'RecoveryAccess — role can recover.',
      viewGraph: 'Graph',
      viewDetails: 'Details',
      cancelAction: 'Cancel',
