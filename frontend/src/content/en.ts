  ...
  cogita: {
    ...
    library: {
      ...
      filters: {
        ...
        placeholderLevel: 'Filter by difficulty'
      },
      add: {
        kicker: 'Add info',
        ...
        group: {
          ...
          topicPlaceholder: 'Search or create topic',
          levelLabel: 'Difficulty level',
          levelPlaceholder: 'Search or create level',
          ...
          wordBPlaceholder: 'Search or create Word B',
          notesLabel: 'Notes',
          notesPlaceholder: 'Optional context for the vocabulary card',
