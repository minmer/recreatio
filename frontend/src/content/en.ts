...
export const en: Copy = {
  ...
  account: {
    ...
    persons: {
      ...
      createMissing: 'Name is required.',
      ...
      lookupLabel: 'Find by login',
      lookupPlaceholder: 'Enter login ID',
      lookupAction: 'Find role',
      lookupWorking: 'Looking up role…',
      lookupSuccess: 'Role found.',
      lookupError: 'Role not found.',
      lookupMissing: 'Login ID is required.',
