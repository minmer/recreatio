  ...
  cogita: {
    ...
    library: {
      ...
      revision: {
        ...
        modeDescriptionRandom: 'Draw a random subset of cards for this session. Cards can repeat between sessions.',
        modeDescriptionRandomOnce: 'Load the full collection, shuffle it, and show each available card exactly once per run.',
        modeDescriptionLevels: 'Use an active stack and move cards through levels based on outcomes.',
        modeDescriptionTemporal: 'Prioritize weaker or older cards using temporal knowness and keep stronger cards less frequent.',
        ...
        effectTries: 'Each card allows up to {value} attempt(s) before reveal.',
        effectMinCorrectness: 'Answers are accepted from {value}% correctness.',
        effectConsiderDependenciesOn: 'Dependency checks are enabled.',
