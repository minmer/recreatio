...
export const en: Copy = {
  ...
  cg: {
    title: 'Cogita Graph',
    subtitle: 'Build vocabulary lists, phonebooks, structured lessons and anything in between using a flexible node-graph model.',
    loginCta: 'Sign in',
    landing: {
      logo: 'Cogita Graph',
      headline: 'Your knowledge,',
      headlineAccent: 'as a connected graph',
      sub: 'Build vocabulary lists, phonebooks, structured lessons and anything in between using a flexible node-graph model. Every piece of information connects.',
      features: [
        { icon: '📖', title: 'Vocabulary', desc: 'Bilingual word pairs in any language combination, ready for revision.' },
        { icon: '📇', title: 'Phonebook',  desc: 'Contacts with multiple phones, emails and notes — always searchable.' },
        { icon: '🎓', title: 'Lesson',     desc: 'Concepts, questions and topics wired together into a structured session.' },
        { icon: '◉',  title: 'Any graph',  desc: 'Define your own node types, fields and relationships from scratch.' },
      ],
      cta: 'Sign in to start',
      linkCogita: '← Back to Cogita (classic)',
      linkHome: 'Recreatio home',
    },
    home: {
      title: 'Graph Libraries',
      sub: 'Each library has its own node schema and graph.',
      newLibrary: '+ New Library',
      wizardTitle: 'New library',
      nameLabel: 'Name',
      namePlaceholder: 'e.g. Spanish vocab, My contacts…',
      templateLabel: 'Template',
      createAction: 'Create library',
      creating: 'Creating…',
      cancel: 'Cancel',
      ...
      templates: {
        vocabulary: { name: 'Vocabulary', desc: 'Bilingual word pairs in any language combination, ready for revision.' },
        phonebook:  { name: 'Phonebook',  desc: 'Contacts with phones, emails and notes — always searchable.' },
        lesson:     { name: 'Lesson',     desc: 'Concepts, questions and topics structured for teaching or studying.' },
        custom:     { name: 'Custom',     desc: 'Start with a blank schema and define your own node types.' },
      },
      templateLabels: { vocabulary: 'Vocabulary', phonebook: 'Phonebook', lesson: 'Lesson', custom: 'Custom' },
      backToCogita: '← Cogita (classic)',
    },
    library: {
      kicker: { vocabulary: 'Vocabulary library', phonebook: 'Phonebook library', lesson: 'Lesson library', custom: 'Custom library' },
    ...
    studio: {
      title: 'Schema editor',
      sub: 'Define node types and their fields. The first field becomes the display label.',
      addField: 'Add field',
      ...
      range: 'Range',
      addAction: 'Add',
      addTypeTitle: 'Add node type',
      typeName: 'Type name',
      typePlaceholder: 'e.g. Person, WordPair…',
      isSubentity: 'Subentity',
      addTypeAction: 'Add type',
      addingType: 'Adding…',
      noFields: 'No fields yet. Add one below.',
      deleteType: 'Delete type',
      addTypeFailed: 'Failed to add node type',
    ...
    graph: {
      ...
      noNodesDesc: 'Add your first one above.',
    },
    node: {
      backAction: '← Back',
      labelSection: 'Label',
      ...
      noLabel: '(no label — click to set)',
      saveAction: 'Save',
      cancelAction: 'Cancel',
      saveFailed: 'Failed to save label',
      fieldSaveFailed: 'Failed to save field',
      deleteValueFailed: 'Failed to delete value',
      multi: '(multi)',
      outgoing: '→',
      incoming: '←',
      created: 'Created:',
