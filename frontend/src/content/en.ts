    ...
    library: {
      ...
      sidebar: {
        ...
        groups: {
          ...
          librarySecurity: 'Security',
          cardsBrowse: 'Browse',
          cardsAdd: 'Add',
          cardsTypes: 'Types',
          collectionsManage: 'Manage',
          collectionsTemplates: 'Templates',
          collectionsRevision: 'Revision',
        ...
        items: {
          ...
          libraryRoles: 'Role graph',
          libraryTransfers: 'Export & import',
          librarySecurity: 'Security & keys',
          typeVocab: 'Vocabulary cards',
          typeLanguage: 'Languages',
          typeWord: 'Words',
          typeSentence: 'Sentences / citations',
          typeTopic: 'Topics',
          typePerson: 'People',
          ...
          revisionQueue: 'Review queue',
          revisionHistory: 'Review history',
          ...
          collectionKnowness: 'Knowness map',
          collectionExport: 'Export collection'
        },
        badges: {
          comingSoon: 'Soon'
        }
      ...
      add: {
        ...
        group: {
          ...
          citationSourceLabelLabel: 'Source label',
          citationSourceLabelPlaceholder: 'Name or identifier of the source',
          citationSourceKindLabel: 'Source kind',
          citationChurchTitleLabel: 'Church document title',
          citationChurchTitlePlaceholder: 'Full title of the document',
          citationChurchShortcutLabel: 'Church document shortcut',
          citationChurchShortcutPlaceholder: 'Short reference name',
          citationChurchAuthorTypeLabel: 'Author type',
          citationChurchAuthorLabel: 'Author',
          citationChurchAuthorPlaceholder: 'Search or create an author',
          citationWorkTitleLabel: 'Work title',
          citationWorkTitlePlaceholder: 'Title of the work',
          citationBookTitleLabel: 'Book title',
          citationBookTitlePlaceholder: 'Title of the book/edition',
          ...
          citationMissingQuote: 'Quote text is required.',
