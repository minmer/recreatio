    ...
    library: {
      ...
      revision: {
        ...
        live: {
          ...
          groupNamePlaceholder: 'e.g. Group A',
          groupsListTitle: 'Saved groups',
          groupsListEmpty: 'No saved groups yet.',
          loadGroupAction: 'Load group',
          currentGroupLabel: 'Current',
          saveGroupAction: 'Save group result',
          groupSavedMessage: 'Group result saved.',
          groupSaveError: 'Failed to save group result.',
          startNextGroupError: 'Failed to start next group session.',
          resumeSessionHint: 'Unfinished sessions stay available in the list and can be resumed at any time.',
          newSessionAction: 'Start next group',
          resetSessionAction: 'Start next group',
