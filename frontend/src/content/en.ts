    ...
    library: {
      ...
      revision: {
        ...
        live: {
          ...
          summaryBonusTimerDetail: 'The bonus timer is {state}. Start: {start}. Time bonus can give up to {startBonus} points at the beginning, about {midOneBonus} after {midOneSeconds}s, about {midTwoBonus} after {midTwoSeconds}s, and 0 after {endSeconds}s.',
