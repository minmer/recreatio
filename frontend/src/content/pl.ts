...
export const pl: Copy = {
  ...
  account: {
    ...
    roles: {
      ...
      relationAdminOf: 'AdminOf — zarządzanie członkami i ustawieniami.',
      relationWrite: 'Write — edycja danych, bez kontroli członków.',
      relationRead: 'Read — tylko odczyt.',
      relationMemberOf: 'MemberOf — członkostwo.',
      relationDelegatedTo: 'DelegatedTo — uprawnienie delegowane.',
      relationData: 'Data — zaszyfrowane pole roli.',
      relationRecoveryOwner: 'RecoveryOwner — rola posiada klucz odzysku.',
      relationRecoveryShare: 'RecoveryShare — udostępnione odzyskanie.',
      relationRecoveryAccess: 'RecoveryAccess — rola może odzyskać.',
      viewGraph: 'Graf',
