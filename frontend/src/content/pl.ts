    ...
    library: {
      ...
      add: {
        ...
        info: {
          ...
          referencesLabel: 'Referencje',
          referencesPlaceholder: 'Szukaj lub utwórz referencje',
          ...
          referenceSourceLabel: 'Źródło',
          referenceSourcePlaceholder: 'Szukaj lub utwórz źródło',
          referenceLocatorTypeLabel: 'Typ lokatora',
          referenceLocatorTypePlaceholder: 'Wybierz typ lokatora',
          referenceLocatorValueLabel: 'Lokalizator',
          referenceLocatorValuePlaceholder: 'Strona, znacznik czasu, sekcja, werset lub fragment URL',
