...
export const pl: Copy = {
  ...
  account: {
    ...
    persons: {
      ...
      createMissing: 'Nazwa jest wymagana.',
      ...
      lookupLabel: 'Znajdź po loginie',
      lookupPlaceholder: 'Podaj login',
      lookupAction: 'Znajdź rolę',
      lookupWorking: 'Wyszukiwanie roli…',
      lookupSuccess: 'Rola znaleziona.',
      lookupError: 'Nie znaleziono roli.',
      lookupMissing: 'Login jest wymagany.',
