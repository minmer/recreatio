  ...
  cogita: {
    ...
    library: {
      ...
      connectionTypes: {
        ...
        reference: 'Informacja - źródło',
        sourceResource: 'Źródło - zasób',
        workContributor: 'Dzieło - współtwórca',
        workMedium: 'Dzieło - medium',
        orcidLink: 'Połączenie ORCID'
      },
      groupTypes: {
        vocab: 'Karta słownictwa',
        citation: 'Cytat',
      ...
      modules: {
        storyboardsTitle: 'Storyboardy',
        storyboardsSubtitle: 'Szkicowa przestrzeń storyboardów dla biblioteki.',
        storyboardsNewLabel: 'Nowy storyboard',
        storyboardsNewPlaceholder: 'Nazwa storyboardu',
        storyboardsCreate: 'Utwórz storyboard',
        storyboardsExisting: 'Istniejące storyboardy',
        storyboardsEmpty: 'Brak storyboardów.',
        textsTitle: 'Teksty',
        textsSubtitle: 'Szkicowa przestrzeń pisania dla biblioteki.',
        textsNewLabel: 'Nowy tekst',
        textsNewPlaceholder: 'Tytuł tekstu',
        textsCreate: 'Utwórz tekst',
        textsExisting: 'Istniejące teksty',
        textsEmpty: 'Brak tekstów.',
        draftInfo: 'Moduł szkicowy. Trwałe zapisywanie będzie dodane w kolejnym kroku.'
      },
      list: {
      ...
      add: {
        ...
        info: {
          ...
          sourceKindLabel: 'Rodzaj źródła',
          sourceKindPlaceholder: 'Wybierz rodzaj źródła',
          sourceResourceTypeLabel: 'Typ zasobu',
          sourceResourceLabel: 'Zasób',
          sourceResourcePlaceholder: 'Szukaj lub utwórz zasób',
          sourceBibleBookLabel: 'Księga (łac.)',
          sourceBibleBookPlaceholder: 'np. Genesis',
          sourceBibleRestLabel: 'Rozdział / werset',
          sourceBibleRestPlaceholder: 'np. 1,1',
          quoteTextLabel: 'Treść cytatu',
          quoteTextPlaceholder: 'Wklej tekst cytatu',
          workLanguageLabel: 'Język dzieła',
          workLanguagePlaceholder: 'Wyszukaj lub utwórz język',
          workOriginalLanguageLabel: 'Język oryginału',
          workOriginalLanguagePlaceholder: 'Wyszukaj lub utwórz język',
          workDoiLabel: 'DOI',
          workDoiPlaceholder: 'np. 10.xxxx/xxxxx',
          mediaTypeLabel: 'Typ medium',
          mediaTypePlaceholder: 'Wybierz typ medium',
          mediaPublisherLabel: 'Wydawca',
          mediaPublisherPlaceholder: 'Nazwa wydawcy',
          mediaPublicationPlaceLabel: 'Miejsce wydania',
          mediaPublicationPlacePlaceholder: 'Miasto',
          mediaPublicationYearLabel: 'Rok wydania',
          mediaPublicationYearPlaceholder: 'RRRR',
          mediaPagesLabel: 'Strony',
          mediaPagesPlaceholder: 'Liczba stron',
          mediaIsbnLabel: 'ISBN',
          mediaIsbnPlaceholder: 'ISBN',
          mediaCoverLabel: 'Okładka',
          mediaCoverPlaceholder: 'Opis okładki',
          mediaHeightLabel: 'Wysokość',
          mediaHeightPlaceholder: 'cm',
          mediaLengthLabel: 'Długość',
          mediaLengthPlaceholder: 'cm',
          mediaWidthLabel: 'Szerokość',
          mediaWidthPlaceholder: 'cm',
          mediaWeightLabel: 'Waga',
          mediaWeightPlaceholder: 'g',
          mediaCollectionLabel: 'Kolekcja',
          mediaCollectionPlaceholder: 'Nazwa kolekcji',
          mediaLocationLabel: 'Miejsce',
          mediaLocationPlaceholder: 'Półka lub archiwum',
          sourceUrlLabel: 'Adres źródła',
          sourceUrlPlaceholder: 'https://…',
          sourceAccessedDateLabel: 'Data dostępu',
          sourceAccessedDatePlaceholder: 'RRRR-MM-DD',
          referenceTitle: 'Referencja',
          referenceToggle: 'Dodaj referencję',
          referenceMissingSource: 'Podaj wymagane dane źródła.',
        ...
        connection: {
          ...
          workLabel: 'Dzieło',
          workPlaceholder: 'Wyszukaj lub utwórz dzieło',
          contributorTypeLabel: 'Typ współtwórcy',
          contributorLabel: 'Współtwórca',
          contributorPlaceholder: 'Wyszukaj lub utwórz współtwórcę',
          contributorRoleLabel: 'Rola współtwórcy',
          contributorRolePlaceholder: 'Autor, tłumacz, redaktor itp.',
          mediumLabel: 'Medium',
          mediumPlaceholder: 'Wyszukaj lub utwórz medium',
          orcidEntityHeader: 'Podmiot',
          orcidHeader: 'ORCID',
          sourceResourceTypeLabel: 'Typ zasobu',
          sourceResourceLabel: 'Zasób',
          sourceResourcePlaceholder: 'Wyszukaj lub utwórz zasób',
          noteLabel: 'Notatka',
          ...
          selectSourceResource: 'Wybierz źródło i zasób.',
          selectQuoteLanguage: 'Wybierz cytat i język.',
          selectWorkContributor: 'Wybierz dzieło, współtwórcę i rolę.',
          selectWorkMedium: 'Wybierz dzieło i medium.',
          selectOrcidLink: 'Wybierz podmiot i ORCID.'
        },
        group: {
          typeLabel: 'Typ grupy',
          ...
          citationBibleBookLabel: 'Księga (łac.)',
          citationBibleBookPlaceholder: 'np. Genesis',
          citationBibleRestLabel: 'Rozdział / werset',
          citationBibleRestPlaceholder: 'np. 1,1',
          citationChurchDocumentLabel: 'Dokument numerowany',
          citationChurchDocumentPlaceholder: 'Wyszukaj lub utwórz dokument numerowany',
          citationWorkLabel: 'Dzieło',
          citationWorkPlaceholder: 'Wyszukaj lub utwórz dzieło',
          citationBookLabel: 'Książka',
          citationBookPlaceholder: 'Wyszukaj lub utwórz książkę',
          citationLocatorValueLabel: 'Lokalizator',
          citationLocatorValuePlaceholder: 'Strona lub numer dokumentu',
          bookTitleLabel: 'Tytuł książki',
          bookTitlePlaceholder: 'np. O państwie Bożym',
          workTitleLabel: 'Tytuł utworu',
          workTitlePlaceholder: 'np. De civitate Dei',
          contributorsLabel: 'Twórcy',
          addContributor: 'Dodaj twórcę',
          removeContributor: 'Usuń',
          bookMissingTitle: 'Tytuł książki jest wymagany.',
          bookMissingWork: 'Tytuł utworu jest wymagany.',
          bookMissingContributor: 'Każdy twórca wymaga roli i osoby/instytucji.',
          citationMissingQuote: 'Treść cytatu jest wymagana.',
          citationMissingSource: 'Podaj wymagane dane źródła.',
          saveVocab: 'Zapisz połączenia słownictwa',
          saveCitation: 'Zapisz cytat',
          saveBook: 'Zapisz informacje o książce',
          savedVocab: 'Połączenia słownictwa zapisane.',
          savedCitation: 'Cytat zapisany.',
          savedBook: 'Informacje o książce zapisane.',
          failed: 'Nie udało się zapisać grupy.',
      ...
      revision: {
        ...
        modeLabel: 'Tryb',
        modeValue: 'Losowy podzbiór',
        modeValueRandomOnce: 'Pełny stos (każda karta raz)',
        modeValueLevels: 'Poziomy',
        modeValueTemporal: 'Czasowy',
        modeDescriptionRandom: 'Losuje podzbiór kart dla tej sesji. Karty mogą wracać między kolejnymi sesjami.',
        modeDescriptionRandomOnce: 'Ładuje całą kolekcję, miesza ją i pokazuje każdą dostępną kartę dokładnie raz na przebieg.',
        modeDescriptionLevels: 'Utrzymuje aktywny stos i przesuwa karty między poziomami zależnie od wyniku odpowiedzi.',
        modeDescriptionTemporal: 'Priorytetowo wybiera słabsze lub starsze karty według znajomości czasowej.',
        commonSettingsTitle: 'Ustawienia wspólne',
        specificSettingsTitle: 'Ustawienia typu powtórki',
        settingsImpactTitle: 'Jak ta powtórka będzie działać',
        settingsImpactIntro: 'Te ustawienia sterują wyborem kart, kolejnością i sposobem sprawdzania.',
        dependencyThresholdDisabledHint: 'Włącz zależności, aby używać tego progu.',
        effectCollection: 'Karty są pobierane z kolekcji: {collection}.',
        effectTries: 'Dla każdej karty dostępne są maksymalnie {value} próby przed podpowiedzią.',
        effectMinCorrectness: 'Odpowiedź jest uznana od progu poprawności {value}%.',
        effectConsiderDependenciesOn: 'Sprawdzanie zależności jest włączone.',
        effectConsiderDependenciesOff: 'Sprawdzanie zależności jest wyłączone; zależności nie blokują kart.',
        effectDependencyThreshold: 'Zależność jest uznawana za spełnioną przy poprawności {value}%.',
        effectStackSize: 'Aktywna kolejka utrzymuje około {value} kart.',
        effectLevels: 'Karty mogą przechodzić przez {value} poziomów.',
        effectCardsPerSession: 'W jednym przebiegu losowanych jest do {value} kart z dostępnej puli.',
        effectReviewer: 'Postęp i znajomość są zapisywane dla osoby: {reviewer}.',
        levelsLabel: 'Poziomy',
        ...
        dependencyThresholdLabel: 'Próg zależności (%)',
        ...
        considerDependenciesLabel: 'Uwzględnij zależności',
        considerDependenciesOn: 'Tak (od małych do dużych)',
        considerDependenciesOff: 'Nie (wszystkie fragmenty)',
        ...
        quoteMissingPlaceholder: 'Wpisz brakujący fragment',
        quoteProgress: 'Sprawdzone zależności: {done} / {total}',
        ...
        dependenciesBlocked: 'Zależności nie są jeszcze spełnione. Najpierw powtórz wymagane karty.',
        ...
        live: {
          hostKicker: 'Host powtórki live',
          hostTitle: 'Sesja hosta',
          joinKicker: 'Powtórka live',
          joinTitle: 'Dołącz do sesji',
          joinCodeLabel: 'Kod dołączenia',
          ...
          participantViewFollowHost: 'Jak u hosta',
          participantViewQuestion: 'Pytanie',
          participantViewScore: 'Wyniki',
          participantViewFullscreen: 'Pełny ekran',
          viewModeLabel: 'Układ',
          viewModeWindow: 'Okno',
          viewModeFullscreen: 'Pełny ekran',
          sessionSettingsLabel: 'Ustawienia sesji (JSON)',
          statusLobby: 'Poczekalnia',
          statusRunning: 'Trwa',
          statusRevealed: 'Po odsłonięciu',
          statusFinished: 'Zakończona',
          roundsLabel: 'Rundy: {count}',
          participantsTitle: 'Uczestnicy',
          scoreboardTitle: 'Wyniki',
          pointsTitle: 'Punkty',
          finalScoreTitle: 'Wynik końcowy',
          currentRoundTitle: 'Aktualna runda',
          questionTitle: 'Pytanie',
          waitingForHostQuestion: 'Czekaj, aż host opublikuje pytanie.',
          waitingForPublishedRound: 'Oczekiwanie na opublikowaną rundę',
          sessionNotStarted: 'Sesja nie została rozpoczęta',
          hiddenBeforeStart: 'Przed startem hosta pytanie nie jest pokazywane.',
          noParticipants: 'Brak uczestników.',
          participantNameLabel: 'Nazwa',
          joinAction: 'Dołącz',
          joiningAction: 'Dołączanie...',
          joinedWaiting: 'Dołączono. Oczekiwanie na hosta.',
          connectionError: 'Błąd połączenia lub nieprawidłowa sesja.',
          submitAnswer: 'Wyślij odpowiedź',
          submitted: 'Wysłano',
          publishCurrentRound: 'Opublikuj aktualną rundę',
          checkAndReveal: 'Sprawdź odpowiedź',
          nextQuestionAction: 'Następne pytanie',
          loading: 'Ładowanie...',
          unsupportedPromptType: 'Nieobsługiwany typ pytania.',
          addPathAction: 'Dodaj ścieżkę',
          fragmentLabel: 'Fragment',
          correctFragmentLabel: 'Poprawny fragment',
          participantAnswerPlaceholder: 'Tu pojawi się odpowiedź uczestnika',
          selectMatchingPairPrompt: 'Wybierz pasującą parę',
          wordLanguagePromptPrefix: 'Język dla',
          loadRoundsError: 'Nie udało się wczytać kart powtórki do sesji live.',
          createSessionError: 'Nie udało się utworzyć sesji live.',
          answerStatusAnswered: 'odpowiedziano',
          answerStatusWaiting: 'oczekiwanie',
          answerStatusCorrect: 'poprawnie',
          answerStatusIncorrect: 'błędnie',
          hostUrlLabel: 'URL hosta',
          presenterUrlLabel: 'URL ekranu',
          newSessionAction: 'Nowa sesja',
          refreshLinksAction: 'Odśwież linki',
          closeSessionAction: 'Zamknij sesję',
          startTimerAction: 'Start timera',
          timerLabel: 'Timer',
          timeExpired: 'Czas odpowiedzi minął dla tej rundy.',
          addParticipantAction: 'Dodaj uczestnika',
          addParticipantPlaceholder: 'Nazwa uczestnika',
          removeParticipantAction: 'Usuń',
          reloginRequestsTitle: 'Prośby o ponowne logowanie',
          allowReloginAction: 'Zezwól',
          reloginPendingMessage: 'Prośba o ponowne logowanie została wysłana. Poczekaj na akceptację hosta i dołącz ponownie.',
          symbolsLegend: 'Symbole: ⚡ pierwszy · 🔥 seria · ⏱ bonus czasu',
          roundGainTitle: 'Punkty za rundę',
          streakLabel: 'Seria',
          onFirstAnswerLabel: 'Po pierwszej odpowiedzi',
          onAllAnsweredLabel: 'Po odpowiedzi wszystkich',
          timerEnabledLabel: 'Timer aktywny',
          timerSecondsLabel: 'Sekundy timera',
          onTimerExpiredLabel: 'Po upływie timera',
          basePointsLabel: 'Punkty bazowe',
          firstCorrectBonusLabel: 'Bonus za pierwszą poprawną',
          speedBonusMaxLabel: 'Maks. bonus szybkości',
          speedGrowthLabel: 'Wzrost bonusu szybkości',
          streakBaseBonusLabel: 'Bazowy bonus serii',
          streakGrowthLabel: 'Wzrost bonusu serii',
          streakLimitLabel: 'Limit serii',
          optionDoNothing: 'Nic nie rób',
          optionStartTimer: 'Uruchom timer',
          optionRevealScore: 'Odkryj + punktuj',
          optionRevealNext: 'Odkryj + następne',
          optionYes: 'Tak',
          optionNo: 'Nie',
          optionLinear: 'Liniowy',
          optionExponential: 'Wykładniczy',
          optionLimited: 'Ograniczony',
          waitingForRevealLabel: 'Oczekiwanie na odkrycie.',
          selectedPathsLabel: 'Wybrane ścieżki',
          removePathAction: 'Usuń',
