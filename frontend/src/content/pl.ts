  ...
  cogita: {
    ...
    library: {
      ...
      filters: {
        ...
        placeholderLevel: 'Filtruj po trudności'
      },
      add: {
        kicker: 'Dodaj info',
        ...
        group: {
          typeLabel: 'Typ grupy',
          topicLabel: 'Tag tematu',
          topicPlaceholder: 'Wyszukaj lub utwórz temat',
          levelLabel: 'Poziom trudności',
          levelPlaceholder: 'Wyszukaj lub utwórz poziom',
          ...
          wordBPlaceholder: 'Wyszukaj lub utwórz słowo B',
          notesLabel: 'Notatki',
          notesPlaceholder: 'Opcjonalny kontekst dla karty słownictwa',
