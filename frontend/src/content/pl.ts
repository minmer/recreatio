    ...
    library: {
      ...
      revision: {
        ...
        live: {
          ...
          summaryEvaluationFlow: 'Punktacja jest liczona etapami: najpierw poprawność odpowiedzi, potem aktywne bonusy, a końcowy wynik rundy jest zapisywany jako liczba całkowita.',
          ...
          summaryBonusTimerDetail: 'Timer bonusu startuje {start}. Na początku bonus czasu może dać do {startBonus} pkt, po {midOneSeconds}s około {midOneBonus} pkt, po {midTwoSeconds}s około {midTwoBonus} pkt, a po {endSeconds}s spada do 0 pkt.',
          summaryBonusTimerDisabled: 'Timer bonusu jest wyłączony, więc bonus czasu nie jest naliczany.',
          summaryStreakDetail: 'Bonus serii ({growth}) może dać do {max} {unit}. Przykładowo: seria {streakOne} -> {bonusOne} {unit}, seria {streakTwo} -> {bonusTwo} {unit}, seria {streakThree} -> {bonusThree} {unit}.',
          summaryStreakDisabled: 'Bonus serii jest wyłączony.',
          summaryAllAnsweredDetail: 'Gdy odpowiedzą wszyscy uczestnicy, system wykona: {allAction}.',
          ...
          summaryActionTimerOnlyDetail: 'Timer akcji jest włączony: po pierwszej odpowiedzi system wykona {firstAction}, a po końcu timera {expireAction}.',
          summaryActionTimerDisabledDetail: 'Timer akcji jest wyłączony, więc po pierwszej odpowiedzi nie ma dodatkowej akcji czasowej.',
