    ...
    library: {
      ...
      revision: {
        ...
        live: {
          ...
          summaryPreset: '{preset}: ten preset ustawia bazowy styl sesji live. Jeżeli ręcznie zmienisz dowolne pole, sesja automatycznie przełączy się na „Własny”, aby było jasne, że nie używasz już dokładnie profilu predefiniowanego.',
          ...
          summaryEvaluationFlow: 'Punkty są liczone etapowo: najpierw poprawność odpowiedzi, potem bonusy, a wynik każdej rundy zapisywany jest jako liczba całkowita.',
          ...
          summaryBonusItem: '{label}: do {value} {unit}',
          summaryBonusesList: 'Aktywne bonusy: {bonuses}.',
          summaryRangeLine: 'W efekcie jedna poprawna odpowiedź może dać od {min} do {max} {unit}.',
          summaryBonusesActive: 'Aktywne bonusy: {bonuses}. Maksymalny dodatkowy zysk z bonusów to {maxBonus} pkt.',
          ...
          summaryStreakDetail: 'Bonus serii działa w trybie {growth} i może dać do {max} {unit}. Przykładowo: seria {streakOne} daje około {bonusOne} {unit}, seria {streakTwo} około {bonusTwo} {unit}, a seria {streakThree} osiąga około {bonusThree} {unit}.',
          summaryStreakDisabled: 'Bonus serii jest wyłączony.',
          summaryAllAnsweredDetail: 'Jeżeli wszyscy uczestnicy odpowiedzą wcześniej, runda kończy się akcją: {allAction}.',
          summaryRoundTimerDetail: 'Dla każdej karty działa osobny timer pytania ({seconds} s); po jego zakończeniu system wykona: {expireAction}.',
          summaryRoundTimerDisabled: 'Timer pytania jest wyłączony, więc długość rundy nie jest ograniczona osobnym limitem czasu.',
          summaryActionFlowDetail: 'Przebieg rundy: po pierwszej odpowiedzi {firstAction}; po odpowiedzi wszystkich {allAction}; po końcu timera akcji {expireAction}.',
