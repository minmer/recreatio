    ...
    library: {
      ...
      revision: {
        ...
        live: {
          ...
          groupNamePlaceholder: 'np. Grupa A',
          groupsListTitle: 'Zapisane grupy',
          groupsListEmpty: 'Brak zapisanych grup.',
          loadGroupAction: 'Wczytaj grupę',
          currentGroupLabel: 'Aktualna',
          saveGroupAction: 'Zapisz wynik grupy',
          groupSavedMessage: 'Wynik grupy zapisany.',
          groupSaveError: 'Nie udało się zapisać wyniku grupy.',
          startNextGroupError: 'Nie udało się uruchomić sesji dla następnej grupy.',
          resumeSessionHint: 'Niedokończone sesje pozostają na liście i można do nich wrócić w dowolnym momencie.',
          newSessionAction: 'Uruchom następną grupę',
          resetSessionAction: 'Uruchom następną grupę',
