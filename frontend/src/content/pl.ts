...
export const pl: Copy = {
  ...
  events: {
    slideTitle: 'Wydarzenia specjalne',
    slideSubtitle: 'Osobne przestrzenie wydarzeń z harmonogramem, informacjami i dedykowanymi podstronami.',
    title: 'Wydarzenia specjalne',
    subtitle: 'Każde wydarzenie ma własny adres URL i własne podstrony, nadal w bazie REcreatio.',
    chooserTitle: 'Wybierz wydarzenie',
    chooserSubtitle: 'Lista jest obecnie wpisana na stałe i później może być pobierana z backendu.',
    pagesLabel: 'Podstrony wydarzenia',
    openEvent: 'Otwórz wydarzenie',
    backToEvents: 'Wszystkie wydarzenia',
    unknownEvent: 'Nie znaleziono wydarzenia.',
    unknownPage: 'Ta podstrona nie istnieje dla wybranego wydarzenia.',
    kal26Header: {
  ...
  limanowa: {
    slideTitle: 'Region Limanowej',
    slideSubtitle: 'Przyszly portal z informacjami o miescie i regionie oraz propozycjami rekreacyjnymi.',
    title: 'Limanowa i okolice',
  ...
  calendar: {
    ...
    subtitle: 'Twoj osobisty i zespolowy kalendarz — widoki miesiac, tydzien, dzien, lista, oś czasu i rok. Zarządzaj wydarzeniami, zadaniami i terminami dla siebie i swojego zespołu.',
    loginCta: 'Zaloguj sie, aby otworzyc kalendarz',
    roadmapTitle: 'Zakres funkcjonalności',
    examplesTitle: 'Przykłady użycia',
    note: 'Zaloguj sie i przejdz do konta, aby utworzyc role — nastepnie kalendarz automatycznie sie skonfiguruje.',
    items: [
  ...
  cogita: {
    ...
    roleIntro: {
      kicker: 'Witaj w Cogita',
      title: 'Jak chcesz zacząć?',
      roles: {
        student: {
          title: 'Chcę się uczyć',
          subtitle: 'Odkrywaj wiedzę przez opowieści, powtórki i wyzwania.'
        },
        teacher: {
          title: 'Chcę uczyć',
          subtitle: 'Twórz storyboardy, zestawy do powtórek i prowadź innych przez wiedzę.'
        },
        explore: {
          title: 'Chcę odkrywać',
    ...
    workspace: {
      ...
      sidebar: {
        ...
        infoActionsHint: 'Akcje elementu wiedzy',
        selectedInfoActionsHint: 'Akcje wybranego elementu wiedzy',
    ...
    core: {
      home: {
        title: 'Cogita Runtime Powtórek',
        subtitle: 'Kanoniczny silnik runtime powtórek z zachowaniem zgodności starej przestrzeni roboczej podczas migracji.',
        libraryIdLabel: 'ID biblioteki',
        runIdLabel: 'ID istniejącego uruchomienia',
        idPlaceholder: '00000000-0000-0000-0000-000000000000',
        startNewRunAction: 'Uruchom nową powtórkę',
        openRunAction: 'Otwórz istniejący bieg'
      },
      run: {
        kicker: 'Cogita Runtime Powtórek',
        defaultRunTitle: 'Bieg',
        generatedRunTitle: 'Bieg runtime powtórki',
        defaultParticipantName: 'Uczestnik',
        scopeLabel: 'Zakres',
        statusLabel: 'Status',
        participantLabel: 'Uczestnik',
        returnToRecreatio: 'Wróć do REcreatio',
        backToCogita: 'Powrót do Runtime',
        loading: 'Ładowanie biegu powtórki...',
        initFailed: 'Nie udało się zainicjalizować biegu powtórki.',
    ...
    library: {
      ...
      overview: {
        ...
        quickActionsText: 'Przejdź do elementów wiedzy, aby przeglądać lub dodać wpis.',
        browseList: 'Przeglądaj listę',
        viewCollections: 'Zobacz kolekcje',
        addInfo: 'Dodaj element wiedzy',
        ...
        focusBody1: 'Każdy element wiedzy jest szyfrowany i łączony relacjami.',
        ...
        importLiveProgress: '{stage}: {done}/{total} (elementów wiedzy {infos}, połączeń {connections}, kolekcji {collections})',
      ...
      modules: {
        ...
        storyboardsEditor: {
          ...
          idMissing: 'Brakuje identyfikatora storyboardu.',
          createdStatus: 'Storyboard utworzony. Otwarty w trybie edycji.',
          savedStatus: 'Storyboard zapisany.',
          invalidLinkStatus: 'Nieprawidłowe źródło lub cel linku.',
          selfLinkStatus: 'Linki do tego samego węzła są niedozwolone.',
          startIncomingStatus: 'Węzeł start nie może mieć linków przychodzących.',
          endOutgoingStatus: 'Węzeł koniec nie może mieć linków wychodzących.',
          creatingAction: 'Tworzenie...',
          savingAction: 'Zapisywanie storyboardu...',
          saveAction: 'Zapisz storyboard',
          runAction: 'Uruchom storyboard',
          shareWorking: 'Trwa...',
          shareCreateAction: 'Utwórz link współdzielony',
          shareCopyAction: 'Kopiuj link współdzielony',
          shareRevokeAction: 'Unieważnij link współdzielony',
          descriptionLabel: 'Opis',
          descriptionPlaceholder: 'Opis storyboardu',
          rootGraphAction: 'Graf główny',
          addStaticAction: 'Dodaj statyczny',
          addCardAction: 'Dodaj kartę',
          addGroupAction: 'Dodaj grupę',
          deleteNodeAction: 'Usuń węzeł',
          deleteLinkAction: 'Usuń link',
          nodeTitleLabel: 'Tytuł węzła',
          nodeDescriptionLabel: 'Opis węzła',
          staticTypeLabel: 'Typ statyczny',
          staticBodyLabel: 'Treść statyczna',
          mediaUrlLabel: 'URL mediów',
          selectedNotionLabel: 'Pojecie',
          selectNotionAction: 'Wybierz element wiedzy',
          checkcardsLoading: 'Ładowanie kart sprawdzających...',
          checkcardsLoadFailed: 'Nie udało się załadować kart sprawdzających.',
          checkcardsEmpty: 'Brak kart sprawdzających powiązanych z tym elementem wiedzy.',
          selectCheckingcardHint: 'Wybierz kartę sprawdzającą (kierunek).',
          overlaySearchLabel: 'Szukaj elementu wiedzy',
          overlaySearchPlaceholder: 'Wpisz co najmniej 2 znaki',
          overlaySearching: 'Wyszukiwanie...',
          overlayNoLinkedCheckcards: 'Brak elementów wiedzy z podpiętymi kartami sprawdzającymi.',
          overlayResultCardsSuffix: 'kart',
          notionIdLabel: 'ID elementu wiedzy',
          directionLabel: 'Kierunek',
          enterGroupAction: 'Wejdź do grafu grupy',
          structuralNodeHelp: 'Węzeł strukturalny ({kind}) jest zarządzany automatycznie i nie można go usunąć.',
          linkLabelLabel: 'Etykieta linku',
          linkLabelPlaceholder: 'Etykieta przycisku',
          displayModeLabel: 'Tryb wyświetlania',
          displayModeNewScreen: 'Nowy ekran',
          displayModeExpand: 'Rozwiń poniżej',
          displayModeFixedHelp: 'Linki kart/zależności zawsze przechodzą bezpośrednio.',
          inspectorEmpty: 'Wybierz węzeł, aby go edytować. Wybierz link, aby go usunąć.',
          overviewNoDescription: 'Brak opisu.',
          overviewNodes: 'Węzły',
          overviewLinks: 'Linki',
          overviewStatic: 'Statyczne',
          overviewCards: 'Karty',
          overviewGroups: 'Grupy',
          overviewStaticBreakdown: 'Tekst / Wideo / Audio / Obraz / Inne',
          sharedLinkLabel: 'Link współdzielony',
          sharedLinkEmpty: 'Nie utworzono jeszcze linku współdzielonego.',
          shareUpdateError: 'Nie udało się zaktualizować linku współdzielonego.',
          shareCopied: 'Skopiowano link współdzielony.',
          shareCopyError: 'Nie udało się skopiować linku współdzielonego.',
          staticTypeText: 'Tekst',
          staticTypeVideo: 'Wideo',
          staticTypeAudio: 'Audio',
          staticTypeImage: 'Obraz',
          staticTypeOther: 'Inne',
          cardDirectionFrontToBack: 'Przód -> Tył',
          cardDirectionBackToFront: 'Tył -> Przód',
          nodeKindStatic: 'Statyczny',
          nodeKindCard: 'Karta',
          nodeKindGroup: 'Logika grupy',
          nodeKindStart: 'Węzeł start',
          nodeKindEnd: 'Węzeł koniec',
          edgeKindDependency: 'Zależność',
          edgeKindRight: 'Poprawna',
          edgeKindWrong: 'Błędna'
        },
        storyboardsRuntime: {
          statusMissingParams: 'Brakuje parametrów trasy storyboardu.',
          statusNotFound: 'Nie znaleziono storyboardu.',
          statusLoadFailed: 'Nie udało się załadować runtime storyboardu.',
          statusLoadSharedFailed: 'Nie udało się załadować współdzielonego runtime storyboardu.',
          choiceFallback: 'Dalej',
          backAction: 'Wróć do storyboardu',
          kicker: 'Runtime storyboardu',
          titleFallback: 'Storyboard',
          restartAction: 'Restart',
          loading: 'Ładowanie runtime...',
          blockUntitled: 'Bez tytułu',
          openMediaAction: 'Otwórz media',
          notionLabel: 'Pojecie',
          notionNotSet: 'nie ustawiono',
          directionLabel: 'Kierunek',
          directionFrontToBack: 'Przód -> Tył',
          directionBackToFront: 'Tył -> Przód',
          cardCheckTypeLabel: 'Typ sprawdzania',
          cardLoading: 'Ładowanie karty sprawdzającej...',
          cardPromptLabel: 'Pytanie',
          cardAnswerLabel: 'Twoja odpowiedź',
          cardAnswerPlaceholder: 'Wpisz odpowiedź',
          cardSubmitAction: 'Wyślij odpowiedź',
          cardRevealLabel: 'Poprawna odpowiedź',
          cardContinueAction: 'Przejdź dalej',
          cardAutoAdvance: 'Przejście do następnego węzła...',
          noCardOutcomeLink: 'Brak skonfigurowanego linku wyjściowego dla tego wyniku karty.',
        ...
        loading: 'Ładowanie...',
        loadFailed: 'Nie udało się wczytać elementów.',
        createFailed: 'Nie udało się utworzyć elementu.',
      ...
      statistics: {
        ...
        hideParticipant: 'Ukryj {name}',
        showParticipant: 'Pokaż {name}',
        openSlide: 'Otwórz slajd statystyk {index}',
        modules: {
          scoreLineTitle: 'Wykres punktów',
          scoreLineSubtitle: 'Oś czasu punktów narastających dla uczestników.',
          knownessWordsTitle: 'Słowa znania',
          knownessWordsSubtitle: 'Najlepiej i najsłabiej znane słowa w tym zakresie.',
          knownessLineTitle: 'Wykres znania',
          knownessLineSubtitle: 'Trend znania w czasie dla uczestników.',
          roundScoreGainTitle: 'Przyrost punktów na rundę',
          roundScoreGainSubtitle: 'Punkty zdobyte w każdej rundzie dla uczestników.',
          responseTimeComparisonTitle: 'Porównanie czasu odpowiedzi',
          responseTimeComparisonSubtitle: 'Średni czas odpowiedzi dla uczestników.',
          responseTimePyramidTitle: 'Piramida czasu odpowiedzi',
          responseTimePyramidSubtitle: 'Podział czasu łącznego: poprawne vs błędne odpowiedzi.',
          responseTimeSplitTitle: 'Czas poprawnych vs błędnych',
          responseTimeSplitSubtitle: 'Podział średniego czasu odpowiedzi poprawnych i błędnych.',
          barChartTitle: 'Wykres słupkowy',
          barChartSubtitle: 'Łączne punkty uczestników.',
          pyramidRankingTitle: 'Ranking piramidalny',
          pyramidRankingSubtitle: 'Średnie punkty za poprawną odpowiedź z podziałem na bazę i bonusy.',
          numberedMetricsTitle: 'Metryki liczbowe',
          numberedMetricsSubtitle: 'Kluczowe wskaźniki z bieżącego zakresu.'
        }
      },
      list: {
      ...
      collections: {
        ...
        deleteConfirm: 'Usunąć tę kolekcję? Tej operacji nie można cofnąć.',
        deleteFail: 'Nie udało się usunąć kolekcji.',
      ...
      revision: {
        ...
        modeDescriptionRandom: 'Tryb losowego podzbioru buduje każdą sesję jako oddzielny przebieg: z całej puli kart dostępnych po filtrach i zależnościach wybierany jest ograniczony zestaw kart na bieżącą sesję. Kolejność jest mieszana, a skład może się zmieniać między uruchomieniami, dlatego ten tryb dobrze sprawdza się przy regularnych, krótkich powtórkach, gdzie chcesz utrzymać różnorodność i uniknąć przewidywalności. Postęp znajomości jest zapisywany po każdej odpowiedzi, więc kolejne sesje nadal uczą się z Twoich wyników, mimo że sam zestaw pytań w danym uruchomieniu jest losowy.',
        modeDescriptionRandomOnce: 'Tryb pełnego stosu (każda karta raz) ładuje całą dostępną pulę kart i układa ją w losowej kolejności, ale bez powtórzeń tej samej karty w jednym przebiegu. Każda karta pojawia się dokładnie raz, dzięki czemu dostajesz pełny, jednorazowy przegląd materiału i możesz łatwo domknąć cały zakres przed egzaminem, spotkaniem lub podsumowaniem tygodnia. To tryb najbardziej przewidywalny pod względem pokrycia materiału: nic nie wypada i nic nie wraca drugi raz w tej samej sesji.',
        modeDescriptionLevels: 'Tryb poziomów utrzymuje aktywny stos kart i dynamicznie zmienia trudność poprzez przesuwanie kart między poziomami na podstawie Twoich odpowiedzi. Karty opanowane przechodzą wyżej i pojawiają się rzadziej, a karty sprawiające trudność wracają niżej i są wzmacniane częściej. Dzięki temu sesja jest adaptacyjna: zamiast sztywnej listy dostajesz strumień pytań, który stale koncentruje się na najsłabszych obszarach, jednocześnie nie tracąc kontaktu z materiałem już poznanym.',
        modeDescriptionTemporal: 'Tryb czasowy opiera wybór kart na rozwoju znajomości w czasie: priorytet otrzymują karty dawno niepowtarzane, niestabilne lub historycznie słabiej odpowiadane. System buduje aktywną kolejkę tak, aby odświeżać to, co najbardziej narażone na zapomnienie, i jednocześnie ograniczać nadmierne powtarzanie treści już utrwalonych. Ten tryb jest najlepszy do długoterminowego utrzymania wiedzy, bo łączy rytm powtórek z historią odpowiedzi, a nie tylko z jednorazowym wynikiem.',
        ...
        effectTries: 'Dla każdej karty możesz wykonać do {value} prób samodzielnej odpowiedzi, zanim system pokaże podpowiedź lub odpowiedź wzorcową; kolejne próby pozwalają poprawić wynik tej samej karty bez natychmiastowego przechodzenia dalej.',
        effectMinCorrectness: 'Odpowiedź jest uznana od progu poprawności {value}%.',
        effectConsiderDependenciesOn: 'Sprawdzanie zależności jest włączone: karta może zostać podana dopiero wtedy, gdy jej karty bazowe (mniejsze elementy wiedzy, wymagane wcześniejsze kroki lub fragmenty składowe) są uznane za wystarczająco opanowane. W praktyce porządkuje to kolejność nauki od fundamentów do bardziej złożonych pytań i zmniejsza liczbę przypadkowych błędów wynikających z braku podstaw.',
        ...
        considerDependenciesOn: 'Tak, uwzględniaj zależności między kartami',
        considerDependenciesOff: 'Nie, traktuj wszystkie karty niezależnie od zależności',
        ...
        live: {
          ...
          classNameLabel: 'Klasa',
          classGroupsLabel: 'Klasy dla uczestników',
          classGroupsPlaceholder: 'np. Klasa A',
          classGroupsHelp: 'Jedna klasa w każdym wierszu. Uczestnik wybiera klasę przy dołączaniu.',
          joinAction: 'Dołącz',
          ...
          scoreHistoryChartAria: 'Wykres historii punktów',
          ...
          stopNextQuestionTimerAction: 'Zatrzymaj timer następnego pytania',
          loading: 'Ładowanie...',
          ...
          detailLaunchTitle: 'Widoki sesji',
          openLoginWallAction: 'Otwórz panel logowania',
          openHostWallAction: 'Otwórz panel hosta',
          openScreenWallAction: 'Otwórz ekran dla wszystkich',
          reloginQrAction: 'QR ponownego logowania',
          reloginQrHelp: 'Zeskanuj kod na nowym urządzeniu i dołącz tą samą nazwą uczestnika.',
          participantPointsLabel: 'Punkty',
          groupNameLabel: 'Nazwa sesji',
          groupNamePlaceholder: 'np. Kopia sesji',
          groupsListTitle: 'Zapisane sesje',
          groupsListEmpty: 'Brak zapisanych sesji.',
          loadGroupAction: 'Otwórz sesję',
          currentGroupLabel: 'Aktualna sesja',
          saveGroupAction: 'Zapisz sesję',
          groupSavedMessage: 'Sesja zapisana.',
          groupSaveError: 'Nie udało się zapisać sesji.',
          startNextGroupError: 'Nie udało się zduplikować sesji.',
          resumeSessionHint: 'Niedokończone sesje pozostają na liście i można do nich wrócić w dowolnym momencie.',
          newSessionAction: 'Duplikuj sesję',
          resetSessionAction: 'Duplikuj sesję',
          ...
          removeParticipantConfirmLabel: 'Usunąć uczestnika „{name}” z tej sesji?',
          cardsLeftLabel: 'Pozostało kart: {count}',
          preparingCardsLabel: 'Przygotowywanie kart: {count}',
          preparedCardsLabel: 'Przygotowane karty: {count}',
          ...
          roundGainDetailsTitle: 'Szczegóły rundy',
          reviewQuestionsTitle: 'Przegląd pytań',
          previousQuestionAction: 'Poprzednie pytanie',
          pauseTimerAction: 'Wstrzymaj timer',
          resumeTimerAction: 'Wznów timer',
          switchParticipantAction: 'Zmień uczestnika',
          useExistingParticipantAction: 'Użyj istniejącego uczestnika',
          chooseDifferentNameAction: 'Wybierz inną nazwę',
          duplicateNameInfoLabel: 'Nazwa „{name}” jest już używana. Jeśli wybierzesz „Użyj istniejącego uczestnika”, przejmiesz jego aktualny wynik i postęp sesji.',
          roundReasonBase: 'za poprawną odpowiedź',
          roundReasonFirst: 'za pierwszą poprawną odpowiedź',
          roundReasonSpeed: 'za odpowiedź w {seconds}s',
          roundReasonStreak: 'za serię {count} poprawnych odpowiedzi',
          roundReasonWrong: 'kara za błędną odpowiedź',
          roundReasonFirstWrong: 'dodatkowa kara za pierwszą błędną odpowiedź',
          roundReasonWrongStreak: 'seria {count} błędnych odpowiedzi',
          asyncScoreContextHelp: 'Porównanie pokazuje wyniki po {count} odpowiedziach dla każdego uczestnika (Twój aktualny etap).',
          bonusExplanation: '✓ punkty bazowe za poprawną odpowiedź, ⚡ bonus za pierwszą poprawną odpowiedź, ⏱ bonus szybkości zależny od pozostałego czasu, 🔥 bonus za serię poprawnych odpowiedzi, ✖ kara za złą odpowiedź.',
          showScoreOverlayAction: 'Pokaż wyniki',
          hideScoreOverlayAction: 'Ukryj wyniki',
          factorBaseLabel: 'Baza',
          factorFirstLabel: 'Pierwsza poprawna',
          factorSpeedLabel: 'Bonus czasu',
          factorStreakLabel: 'Bonus serii',
          factorWrongLabel: 'Kara za błędną odpowiedź',
          factorFirstWrongLabel: 'Kara za pierwszą błędną',
          factorWrongStreakLabel: 'Kara za serię błędnych',
          streakLabel: 'Seria',
          onFirstAnswerLabel: 'Po pierwszej odpowiedzi',
          onAllAnsweredLabel: 'Po odpowiedzi wszystkich',
          roundTimerLabel: 'Timer pytania',
          roundTimerEnabledLabel: 'Timer pytania aktywny',
          roundTimerSecondsLabel: 'Sekundy timera pytania',
          roundTimerExpireLabel: 'Po upływie timera pytania',
          actionTimerLabel: 'Timer akcji',
          timerEnabledLabel: 'Timer aktywny',
          timerSecondsLabel: 'Sekundy timera',
          onTimerExpiredLabel: 'Po upływie timera',
          nextQuestionBehaviorLabel: 'Następne pytanie',
          nextQuestionModeLabel: 'Sposób przejścia do następnego pytania',
          nextQuestionModeManual: 'Ręcznie (klik hosta)',
          nextQuestionModeTimer: 'Automatycznie po czasie',
          nextQuestionTimerSecondsLabel: 'Sekundy auto-przejścia',
          nextQuestionTimerLabel: 'Timer następnego pytania',
          bonusTimerLabel: 'Timer bonusu',
          bonusTimerEnabledLabel: 'Timer bonusu aktywny',
          bonusTimerSecondsLabel: 'Sekundy timera bonusu',
          bonusTimerStartLabel: 'Start timera bonusu',
          bonusTimerStartAfterFirst: 'Po pierwszej odpowiedzi',
          bonusTimerStartRound: 'Na początku rundy',
          basePointsLabel: 'Punkty bazowe',
          firstCorrectBonusLabel: 'Bonus za pierwszą poprawną',
          firstBonusModeLabel: 'Tryb bonusu za pierwszą odpowiedź',
          firstBonusModeFirstAnswer: 'Pierwsza odpowiedź (nawet błędna)',
          firstBonusModeFirstCorrect: 'Pierwsza poprawna odpowiedź',
          wrongAnswerPenaltyLabel: 'Kara za błędną odpowiedź',
          firstWrongPenaltyLabel: 'Dodatkowa kara za pierwszą błędną odpowiedź',
          firstWrongPenaltyModeLabel: 'Tryb kary za pierwszą błędną',
          firstWrongPenaltyModeOverallFirst: 'Tylko gdy pierwsza odpowiedź rundy była błędna',
          firstWrongPenaltyModeFirstWrong: 'Pierwsza błędna odpowiedź w rundzie',
          speedBonusEnabledLabel: 'Bonus szybkości aktywny',
          speedBonusMaxLabel: 'Maks. bonus szybkości',
          speedGrowthLabel: 'Wzrost bonusu szybkości',
          streakBaseBonusLabel: 'Bazowy bonus serii',
          streakBonusEnabledLabel: 'Bonus serii aktywny',
          streakGrowthLabel: 'Wzrost bonusu serii',
          streakLimitLabel: 'Limit serii',
          wrongStreakPenaltyEnabledLabel: 'Kara za serię błędnych aktywna',
          wrongStreakBasePenaltyLabel: 'Bazowa kara za serię błędnych',
          wrongStreakGrowthLabel: 'Wzrost kary za serię błędnych',
          wrongStreakLimitLabel: 'Limit serii błędnych',
          presetLabel: 'Preset sesji',
          presetBalancedDuel: 'Zbalansowany pojedynek',
          presetFirstStrike: 'Pierwsza odpowiedź wygrywa',
          presetSprintRace: 'Sprint na czas',
          presetAccuracyFocus: 'Nacisk na poprawność',
          presetStreakMaster: 'Mistrz serii',
          presetMarathonClassic: 'Klasyczny maraton',
          presetAsyncChallenge: 'Wyzwanie asynchroniczne',
          presetCustom: 'Własny (niestandardowy)',
          summaryTitle: 'Jak ta sesja będzie działać',
          summaryPreset: 'Używasz presetu {preset}. Ten preset ustawia bazowy styl sesji live. Jeżeli ręcznie zmienisz dowolne pole, sesja automatycznie przełączy się na „Własny”, aby było jasne, że nie używasz już dokładnie profilu predefiniowanego.',
          summaryPoints: 'Bazowa punktacja za poprawną odpowiedź to {base} pkt, a bonus za pierwszą poprawną odpowiedź to {first} pkt.',
          summaryTimerEnabled: 'Timer jest aktywny i trwa {seconds} sekund.',
          summaryTimerDisabled: 'Timer jest wyłączony, więc odpowiedzi nie są ograniczone czasowo.',
          summaryScoringFlow: 'Każda poprawna odpowiedź uczestnika daje {base} pkt. Jeżeli uczestnik odpowie jako pierwszy poprawnie, dostaje dodatkowo {first} pkt. Dla pozostałych może być naliczany bonus czasu: po {halfSeconds} sekundach bonus spada do około {halfBonus} pkt, a po {seconds} sekundach wynosi {endBonus} pkt.',
          summaryBasePoints: 'Każda poprawna odpowiedź uczestnika daje {base} pkt.',
          summarySpeedCurve: 'Krzywa bonusu czasu: po {halfSeconds}s ≈ {halfBonus} pkt, po {endSeconds}s = {endBonus} pkt.',
          summaryAsyncPreset: 'To jest preset asynchroniczny: ukryto część ustawień czasu i automatycznych akcji rundy, bo uczestnicy rozwiązują materiał we własnym tempie.',
          summarySyncPreset: 'To jest preset synchroniczny: uczestnicy odpowiadają na te same pytania równolegle, a host steruje tempem rundy.',
          summaryBonusNone: 'W tej konfiguracji bonusy są wyłączone: uczestnik dostaje tylko punkty bazowe za poprawną odpowiedź ({base} pkt).',
          summaryBonusFirst: 'Za pierwszą poprawną odpowiedź można otrzymać dodatkowo do {first} pkt.',
          summaryBonusSpeed: 'Bonus szybkości może dać maksymalnie {max} pkt i maleje do zera wraz z upływem timera bonusu.',
          summaryBonusStreak: 'Bonus serii jest aktywny. Rośnie według trybu {growth} i osiąga pełną wartość po {limit} kolejnych poprawnych odpowiedziach.',
          summaryWrongPenalty: 'Błędna wysłana odpowiedź obniża wynik o maksymalnie {penalty} {unit}.',
          summaryFirstWrongPenalty: 'Jeżeli pierwsza wysłana odpowiedź w rundzie jest błędna, naliczana jest dodatkowa kara do {penalty} {unit}.',
          summaryNoWrongPenalty: 'Błędne odpowiedzi nie obniżają punktów.',
          summaryBonusSpeedDisabled: 'Bonus szybkości jest wyłączony.',
          summaryBonusStreakDisabled: 'Bonus serii jest wyłączony.',
          summaryEvaluationFlow: 'Punkty są liczone etapowo. Najpierw oceniana jest poprawność odpowiedzi, potem doliczane są bonusy, a wynik każdej rundy zapisywany jest jako liczba całkowita.',
          summaryPointsTotalHint: 'Przy tych ustawieniach typowy zysk za jedną poprawną odpowiedź to około {min}–{max} pkt.',
          summaryStreak: 'Bonus serii rośnie w trybie {growth} do maksymalnie {max} pkt i osiąga pełny efekt po {limit} poprawnych odpowiedziach pod rząd.',
          summaryActions: 'Przebieg rundy: po pierwszej odpowiedzi -> {firstAction}; po odpowiedzi wszystkich -> {allAction}; po końcu timera akcji -> {expireAction}.',
          summaryTypeLineSync: 'To sesja synchroniczna. Wszyscy uczestnicy odpowiadają równolegle na te same pytania, a host steruje tempem rundy.',
          summaryTypeLineAsync: 'To sesja asynchroniczna. Uczestnicy rozwiązują materiał we własnym tempie, a wyniki są dalej porównywane na wspólnej tablicy.',
          summaryBasePointsDetailed: 'Za jedną poprawną odpowiedź uczestnik otrzymuje {base} {unit}.',
          summaryBonusItem: '{label} może dodać do {value} {unit}',
          summaryBonusesList: 'Aktywne bonusy to {bonuses}.',
          summaryRangeLine: 'W efekcie jedna poprawna odpowiedź może dać od {min} do {max} {unit}.',
          summaryBonusesActive: 'Aktywne bonusy to {bonuses}. Maksymalny dodatkowy zysk z bonusów to {maxBonus} pkt.',
          summaryBonusesNone: 'Bonusy są wyłączone, więc za poprawną odpowiedź naliczane są tylko punkty bazowe.',
          summaryBonusTimerDetail: 'Timer bonusu uruchamia się {start}. Na starcie bonus czasu może dać do {startBonus} pkt, po {midOneSeconds}s spada do około {midOneBonus} pkt, po {midTwoSeconds}s do około {midTwoBonus} pkt, a po {endSeconds}s wynosi już 0 pkt.',
          summaryBonusTimerDisabled: 'Timer bonusu jest wyłączony, więc bonus czasu nie jest naliczany.',
          summaryStreakDetail: 'Bonus serii w trybie {growth} może dać do {max} {unit}. Przykładowo seria {streakOne} daje około {bonusOne} {unit}, seria {streakTwo} około {bonusTwo} {unit}, a seria {streakThree} około {bonusThree} {unit}.',
          summaryStreakDisabled: 'Bonus serii jest wyłączony.',
          summaryAllAnsweredDetail: 'Jeżeli wszyscy uczestnicy odpowiedzą wcześniej, sesja wykona akcję {allAction}.',
          summaryRoundTimerDetail: 'Dla każdej karty działa osobny timer pytania przez {seconds} s. Po jego zakończeniu system wykona {expireAction}.',
          summaryRoundTimerDisabled: 'Timer pytania jest wyłączony, więc długość rundy nie jest ograniczona osobnym limitem czasu.',
          summaryNextQuestionManual: 'Po punktacji host ręcznie przechodzi do kolejnego pytania.',
          summaryNextQuestionTimer: 'Po punktacji sesja automatycznie przejdzie do kolejnego pytania po {seconds} sekundach, chyba że host zatrzyma ten timer.',
          summaryActionFlowDetail: 'Po pierwszej odpowiedzi sesja wykonuje {firstAction}. Po odpowiedzi wszystkich wykonuje {allAction}. Po końcu timera akcji wykonuje {expireAction}.',
          summaryActionTimerOnlyDetail: 'Po pierwszej odpowiedzi system wykona {firstAction}. Po zakończeniu timera akcji wykona {expireAction}.',
          summaryActionTimerDisabledDetail: 'Dodatkowy timer akcji jest wyłączony, więc po pierwszej odpowiedzi nie uruchamia się osobne odliczanie.',
          bonusUsageLabel: 'Użyj bonusów dla',
          bonusUsageAll: 'Wszystkie bonusy',
          bonusUsageNone: 'Bez bonusów',
          bonusUsageFirst: 'Tylko pierwszy poprawny',
          bonusUsageSpeed: 'Tylko szybkość odpowiedzi',
          bonusUsageStreak: 'Tylko seria odpowiedzi',
      ...
      graph: {
        ...
        previewBreakdown: '{connections} połączeń · {infos} elementów wiedzy',
  ...
  cg: {
    title: 'Cogita Graph',
    subtitle: 'Twórz listy słownictwa, książki telefoniczne, lekcje i wiele więcej przy pomocy elastycznego modelu grafu węzłów.',
    loginCta: 'Zaloguj się',
    landing: {
      logo: 'Cogita Graph',
      headline: 'Twoja wiedza,',
      headlineAccent: 'jako połączony graf',
      sub: 'Twórz listy słownictwa, książki telefoniczne, ustrukturyzowane lekcje i wiele więcej przy pomocy elastycznego modelu grafu węzłów. Każda informacja jest połączona.',
      features: [
        { icon: '📖', title: 'Słownictwo', desc: 'Dwujęzyczne pary słów w dowolnej kombinacji językowej, gotowe do powtarzania.' },
        { icon: '📇', title: 'Książka telefoniczna', desc: 'Kontakty z wieloma telefonami, e-mailami i notatkami — zawsze przeszukiwalne.' },
        { icon: '🎓', title: 'Lekcja', desc: 'Pojęcia, pytania i tematy połączone w ustrukturyzowaną sesję.' },
        { icon: '◉',  title: 'Dowolny graf', desc: 'Definiuj własne typy węzłów, pola i relacje od podstaw.' },
      ],
      cta: 'Zaloguj się, aby zacząć',
      linkCogita: '← Wróć do Cogita (klasyczny)',
      linkHome: 'Strona główna Recreatio',
    },
    home: {
      title: 'Biblioteki grafów',
      sub: 'Każda biblioteka ma własny schemat węzłów i graf.',
      newLibrary: '+ Nowa biblioteka',
      wizardTitle: 'Nowa biblioteka',
      nameLabel: 'Nazwa',
      namePlaceholder: 'np. Słówka po hiszpańsku, Moje kontakty…',
      templateLabel: 'Szablon',
      createAction: 'Utwórz bibliotekę',
      creating: 'Tworzenie…',
      cancel: 'Anuluj',
      loadFailed: 'Nie udało się załadować bibliotek',
      createFailed: 'Nie udało się utworzyć biblioteki',
      deleteFailed: 'Nie udało się usunąć biblioteki',
      deleteConfirm: 'Potwierdź usunięcie',
      deleteCancel: 'Anuluj',
      emptyTitle: 'Brak bibliotek.',
      emptyDesc: 'Utwórz jedną, aby zacząć.',
      templates: {
        vocabulary: { name: 'Słownictwo', desc: 'Dwujęzyczne pary słów w dowolnej kombinacji językowej, gotowe do powtarzania.' },
        phonebook:  { name: 'Książka telefoniczna', desc: 'Kontakty z telefonami, e-mailami i notatkami — zawsze przeszukiwalne.' },
        lesson:     { name: 'Lekcja', desc: 'Pojęcia, pytania i tematy ustrukturyzowane do nauczania lub nauki.' },
        custom:     { name: 'Własny', desc: 'Zacznij od pustego schematu i zdefiniuj własne typy węzłów.' },
      },
      templateLabels: { vocabulary: 'Słownictwo', phonebook: 'Książka tel.', lesson: 'Lekcja', custom: 'Własny' },
      backToCogita: '← Cogita (klasyczny)',
    },
    library: {
      kicker: { vocabulary: 'Biblioteka słownictwa', phonebook: 'Książka telefoniczna', lesson: 'Biblioteka lekcji', custom: 'Biblioteka własna' },
      renameFailed: 'Nie udało się zmienić nazwy',
      saveAction: 'Zapisz',
      cancelAction: 'Anuluj',
      nodeTypes: 'Typy węzłów',
      fields: 'Pola',
      nodes: 'Węzły',
      browseNodes: '▶ Przeglądaj węzły',
      editSchema: '✎ Edytuj schemat',
      schemaPreview: 'Podgląd schematu',
      noFields: 'Brak zdefiniowanych pól',
      subentity: 'podentity',
      goTo: 'Przejdź do',
      allNodes: 'Wszystkie węzły',
      schemaEditor: 'Edytor schematu',
      allLibraries: '← Wszystkie biblioteki',
    },
    studio: {
      title: 'Edytor schematu',
      sub: 'Definiuj typy węzłów i ich pola. Pierwsze pole staje się etykietą wyświetlaną.',
      addField: 'Dodaj pole',
      fieldName: 'Nazwa pola',
      fieldType: 'Typ',
      multiValue: 'Wielowartościowe',
      range: 'Zakres',
      addAction: 'Dodaj',
      addTypeTitle: 'Dodaj typ węzła',
      typeName: 'Nazwa typu',
      typePlaceholder: 'np. Osoba, ParaSłów…',
      isSubentity: 'Podentity',
      addTypeAction: 'Dodaj typ',
      addingType: 'Dodawanie…',
      noFields: 'Brak pól. Dodaj jedno poniżej.',
      deleteType: 'Usuń typ',
      addTypeFailed: 'Nie udało się dodać typu węzła',
      addFieldFailed: 'Nie udało się dodać pola',
      deleteFieldFailed: 'Nie udało się usunąć pola',
      deleteTypeFailed: 'Nie udało się usunąć typu węzła',
      labelIndex: '★',
    },
    graph: {
      title: 'Węzły',
      searchPlaceholder: 'Szukaj po etykiecie…',
      allTypes: 'Wszystkie typy',
      addNode: 'Dodaj węzeł',
      labelPlaceholder: 'Etykieta',
      addAction: '+ Dodaj',
      adding: 'Dodawanie…',
      loadFailed: 'Nie udało się załadować węzłów',
      createFailed: 'Nie udało się utworzyć węzła',
      deleteFailed: 'Nie udało się usunąć węzła',
      labelColumn: 'Etykieta',
      typeColumn: 'Typ',
      noNodes: 'Brak węzłów.',
      noNodesDesc: 'Dodaj pierwszy powyżej.',
    },
    node: {
      backAction: '← Wróć',
      labelSection: 'Etykieta',
      fieldsSection: 'Pola',
      connectionsSection: 'Połączenia',
      noLabel: '(brak etykiety — kliknij, aby ustawić)',
      saveAction: 'Zapisz',
      cancelAction: 'Anuluj',
      saveFailed: 'Nie udało się zapisać etykiety',
      fieldSaveFailed: 'Nie udało się zapisać pola',
      deleteValueFailed: 'Nie udało się usunąć wartości',
      multi: '(wielowartościowe)',
      outgoing: '→',
      incoming: '←',
      created: 'Utworzono:',
