    ...
    library: {
      ...
      add: {
        ...
        group: {
          ...
          citationSourceLabelLabel: 'Etykieta źródła',
          citationSourceLabelPlaceholder: 'Nazwa lub identyfikator źródła',
          citationSourceKindLabel: 'Rodzaj źródła',
          citationChurchTitleLabel: 'Tytuł dokumentu kościelnego',
          citationChurchTitlePlaceholder: 'Pełny tytuł dokumentu',
          citationChurchShortcutLabel: 'Skrót dokumentu kościelnego',
          citationChurchShortcutPlaceholder: 'Krótka nazwa referencji',
          citationChurchAuthorTypeLabel: 'Typ autora',
          citationChurchAuthorLabel: 'Autor',
          citationChurchAuthorPlaceholder: 'Wyszukaj lub utwórz autora',
          citationWorkTitleLabel: 'Tytuł dzieła',
          citationWorkTitlePlaceholder: 'Tytuł dzieła',
          citationBookTitleLabel: 'Tytuł książki',
          citationBookTitlePlaceholder: 'Tytuł książki/wydania',
