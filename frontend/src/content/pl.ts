...
export const pl: Copy = {
  ...
  account: {
    ...
    roles: {
      ...
      edgeTitle: 'Relacja',
      linkDraftTitle: 'Szkic połączenia',
      linkDraftHint: 'Podgląd UI. Logika backendu dojdzie później.',
      createOwnedRole: 'Utwórz rolę podrzędną',
      createOwnedRoleHint: 'Podgląd UI. Właścicielem będzie wybrana rola.',
    ...
    persons: {
      ...
      nameLabel: 'Nick',
      namePlaceholder: 'Prywatna etykieta (nie imię i nazwisko)',
      ...
      createMissing: 'Nick jest wymagany.',
      ...
      dataEmpty: 'Brak danych osobowych.',
      dataEdit: 'Edytuj',
      dataTypeLabel: 'Typ',
      dataTypePlaceholder: 'imię, data urodzenia, itp.',
      dataValueLabel: 'Wartość',
      dataValuePlaceholder: 'Wpisz wartość',
      dataAction: 'Zapisz dane',
      dataWorking: 'Zapisywanie danych…',
      ...
      accessEmpty: 'Brak udostępnionych ról.',
      pendingTitle: 'Oczekujące udostępnienia',
      pendingAccept: 'Akceptuj',
      pendingWorking: 'Akceptowanie udostępnienia…',
      pendingSuccess: 'Udostępnienie zaakceptowane.',
      pendingError: 'Nie udało się zaakceptować udostępnienia.',
      memberTitle: 'Udostępnij roli',
      lookupLabel: 'Znajdź po nicku',
      lookupPlaceholder: 'Podaj nick roli',
      lookupAction: 'Znajdź rolę',
      lookupWorking: 'Wyszukiwanie ról…',
      lookupSuccess: 'Role załadowane.',
      lookupError: 'Nie znaleziono ról.',
      lookupMissing: 'Nick jest wymagany.',
      memberRoleLabel: 'Id roli docelowej',
      memberRolePlaceholder: 'Wklej identyfikator roli',
      memberTypeLabel: 'Rola dostępu',
      memberAction: 'Udostępnij rolę',
      memberWorking: 'Udostępnianie roli…',
      memberSuccess: 'Rola została udostępniona.',
      memberError: 'Nie udało się udostępnić roli.',
      memberMissing: 'Id roli jest wymagane.',
