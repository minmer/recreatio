    ...
    library: {
      ...
      revision: {
        ...
        live: {
          ...
          summaryEvaluationFlow: 'Ocena rundy przebiega etapowo: najpierw sprawdzana jest poprawność odpowiedzi, następnie doliczane są aktywne bonusy, a końcowy wynik rundy zapisywany jest jako liczba całkowita.',
          summaryPointsTotalHint: 'Przy tych ustawieniach typowy zysk za pytanie dla poprawnej odpowiedzi mieści się najczęściej w zakresie około {min}–{max} pkt.',
          ...
          summaryActions: 'Akcja po pierwszej odpowiedzi: {firstAction}. Akcja po odpowiedzi wszystkich: {allAction}. Akcja po końcu timera: {expireAction}.',
