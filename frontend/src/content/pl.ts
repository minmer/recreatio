    ...
    library: {
      ...
      revision: {
        ...
        live: {
          ...
          summaryBonusFirst: 'Bonus za pierwszą poprawną odpowiedź jest aktywny i wynosi {first} pkt.',
          summaryBonusSpeed: 'Bonus szybkości jest aktywny: jego maksimum to {max} pkt i maleje do zera wraz z upływem timera.',
          ...
          summaryBasePointsDetailed: 'Punkty bazowe za jedną poprawną odpowiedź: {base} {unit}.',
          ...
          summaryBonusTimerDetail: 'Timer bonusu jest {state}. Start: {start}. Bonus czasu na początku rundy wynosi do {startBonus} pkt, po {midOneSeconds}s około {midOneBonus} pkt, po {midTwoSeconds}s około {midTwoBonus} pkt, a po {endSeconds}s spada do 0 pkt.',
          ...
          summaryAllAnsweredDetail: 'Po odpowiedzi wszystkich uczestników: {allAction}.',
          summaryActionFlowDetail: 'Timer akcji jest {timerState}. Po pierwszej odpowiedzi: {firstAction}. Po odpowiedzi wszystkich: {allAction}. Po końcu timera akcji: {expireAction}.',
