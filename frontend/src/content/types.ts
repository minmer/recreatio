    ...
    library: {
      ...
      add: {
        ...
        group: {
          ...
          citationChurchTitleLabel: string;
          citationChurchTitlePlaceholder: string;
          citationChurchShortcutLabel: string;
          citationChurchShortcutPlaceholder: string;
          citationChurchAuthorTypeLabel: string;
          citationChurchAuthorLabel: string;
          citationChurchAuthorPlaceholder: string;
          citationWorkTitleLabel: string;
          citationWorkTitlePlaceholder: string;
          citationBookTitleLabel: string;
          citationBookTitlePlaceholder: string;
