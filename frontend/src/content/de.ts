  ...
  cogita: {
    ...
    library: {
      ...
      connectionTypes: {
        ...
        citationLanguage: 'Zitat - Sprache',
      ...
      modules: {
        ...
        storyboardsSubtitle: 'Entwurfsbereich für Storyboards in dieser Bibliothek.',
        storyboardsNewLabel: 'Neues Storyboard',
        storyboardsNewPlaceholder: 'Storyboard-Name',
        storyboardsCreate: 'Storyboard erstellen',
        storyboardsExisting: 'Vorhandene Storyboards',
        storyboardsEmpty: 'Noch keine Storyboards.',
        textsTitle: 'Texte',
        textsSubtitle: 'Entwurfsbereich zum Schreiben in dieser Bibliothek.',
        textsNewLabel: 'Neuer Text',
        textsNewPlaceholder: 'Texttitel',
        textsCreate: 'Text erstellen',
        textsExisting: 'Vorhandene Texte',
        textsEmpty: 'Noch keine Texte.',
        draftInfo: 'Nur Entwurfsmodul. Persistenz folgt im nächsten Schritt.'
      },
      list: {
        ...
        typeFilterCitationText: 'Zitattext'
      },
      filters: {
        title: 'Filter',
      ...
      revision: {
        ...
        modeLabel: 'Modus',
        modeValue: 'Zufällige Teilmenge',
        modeValueRandomOnce: 'Voller Stapel (jede Karte einmal)',
        modeValueLevels: 'Stufen',
        modeValueTemporal: 'Zeitverlauf',
        modeDescriptionRandom: 'Verwendet pro Sitzung eine zufällige Teilmenge. Karten können zwischen Sitzungen wiederkehren.',
        modeDescriptionRandomOnce: 'Lädt die gesamte Sammlung, mischt sie und zeigt jede verfügbare Karte genau einmal pro Durchlauf.',
        modeDescriptionLevels: 'Arbeitet mit einem aktiven Stapel und verschiebt Karten je nach Antwortergebnis durch Stufen.',
        modeDescriptionTemporal: 'Priorisiert schwächere oder länger nicht geprüfte Karten anhand der zeitlichen Bekanntheit.',
        commonSettingsTitle: 'Gemeinsame Einstellungen',
        specificSettingsTitle: 'Typspezifische Einstellungen',
        settingsImpactTitle: 'So verhält sich diese Wiederholung',
        settingsImpactIntro: 'Diese Einstellungen steuern Kartenauswahl, Reihenfolge und Antwortprüfung.',
        dependencyThresholdDisabledHint: 'Aktiviere Abhängigkeiten, um diesen Schwellenwert zu nutzen.',
        effectCollection: 'Die Karten werden aus folgender Sammlung geladen: {collection}.',
        effectTries: 'Pro Karte sind bis zu {value} Versuch(e) vor der Anzeige erlaubt.',
        effectMinCorrectness: 'Antworten gelten ab {value}% Korrektheit als richtig.',
        effectConsiderDependenciesOn: 'Abhängigkeitsprüfungen sind aktiviert.',
        effectConsiderDependenciesOff: 'Abhängigkeitsprüfungen sind deaktiviert; Abhängigkeiten blockieren keine Karten.',
        effectDependencyThreshold: 'Eine Abhängigkeit gilt ab {value}% Korrektheit als erfüllt.',
        effectStackSize: 'Die aktive Warteschlange enthält etwa {value} Karte(n).',
        effectLevels: 'Karten können über {value} Stufe(n) aufsteigen.',
        effectCardsPerSession: 'Pro Durchlauf werden bis zu {value} Karten aus dem verfügbaren Pool gezogen.',
        effectReviewer: 'Fortschritt und Bekanntheit werden für folgende Person gespeichert: {reviewer}.',
        levelsLabel: 'Stufen',
        ...
        live: {
          hostKicker: 'Live-Wiederholung Host',
          hostTitle: 'Host-Sitzung',
          joinKicker: 'Live-Wiederholung',
          joinTitle: 'Sitzung beitreten',
          ...
          participantViewFollowHost: 'Wie Host',
          participantViewQuestion: 'Frage',
          participantViewScore: 'Punktestand',
          participantViewFullscreen: 'Vollbild',
          viewModeLabel: 'Layout',
          viewModeWindow: 'Fenster',
          viewModeFullscreen: 'Vollbild',
          sessionSettingsLabel: 'Sitzungseinstellungen (JSON)',
          statusLobby: 'Lobby',
          statusRunning: 'Läuft',
          statusRevealed: 'Aufgedeckt',
          statusFinished: 'Beendet',
          roundsLabel: 'Runden: {count}',
          participantsTitle: 'Teilnehmende',
          scoreboardTitle: 'Punktestand',
          pointsTitle: 'Punkte',
          finalScoreTitle: 'Endstand',
          currentRoundTitle: 'Aktuelle Runde',
          questionTitle: 'Frage',
          waitingForHostQuestion: 'Warte, bis der Host eine Frage veröffentlicht.',
          waitingForPublishedRound: 'Warten auf veröffentlichte Runde',
          sessionNotStarted: 'Sitzung nicht gestartet',
          hiddenBeforeStart: 'Vor dem Start des Hosts wird keine Frage angezeigt.',
          noParticipants: 'Noch keine Teilnehmenden.',
          participantNameLabel: 'Name',
          joinAction: 'Beitreten',
          joiningAction: 'Beitritt...',
          joinedWaiting: 'Beigetreten. Warten auf den Host.',
          connectionError: 'Verbindungsfehler oder ungültige Sitzung.',
          submitAnswer: 'Antwort senden',
          submitted: 'Gesendet',
          publishCurrentRound: 'Aktuelle Runde veröffentlichen',
          checkAndReveal: 'Antwort prüfen',
          nextQuestionAction: 'Nächste Frage',
          loading: 'Lädt...',
          unsupportedPromptType: 'Nicht unterstützter Fragetyp.',
          addPathAction: 'Pfad hinzufügen',
          fragmentLabel: 'Fragment',
          correctFragmentLabel: 'Richtiges Fragment',
          participantAnswerPlaceholder: 'Antwort der Teilnehmenden erscheint hier',
          selectMatchingPairPrompt: 'Passendes Paar auswählen',
          wordLanguagePromptPrefix: 'Sprache von',
          loadRoundsError: 'Wiederholungskarten für die Live-Sitzung konnten nicht geladen werden.',
          createSessionError: 'Live-Sitzung konnte nicht erstellt werden.',
          answerStatusAnswered: 'beantwortet',
          answerStatusWaiting: 'wartet',
          answerStatusCorrect: 'richtig',
          answerStatusIncorrect: 'falsch',
          hostUrlLabel: 'Host-URL',
          presenterUrlLabel: 'Anzeige-URL',
          ...
          timerLabel: 'Timer',
          timeExpired: 'Zeit für diese Runde abgelaufen.',
          addParticipantAction: 'Teilnehmende hinzufügen',
          addParticipantPlaceholder: 'Name der teilnehmenden Person',
          removeParticipantAction: 'Entfernen',
          reloginRequestsTitle: 'Anfragen zum erneuten Login',
          allowReloginAction: 'Erlauben',
          reloginPendingMessage: 'Anfrage für erneuten Login gesendet. Warte auf Freigabe durch den Host und trete erneut bei.',
          symbolsLegend: 'Symbole: ⚡ zuerst · 🔥 Serie · ⏱ Zeitbonus',
          roundGainTitle: 'Rundengewinn',
          streakLabel: 'Serie',
          onFirstAnswerLabel: 'Bei erster Antwort',
          onAllAnsweredLabel: 'Wenn alle geantwortet haben',
          timerEnabledLabel: 'Timer aktiv',
          timerSecondsLabel: 'Timer-Sekunden',
          onTimerExpiredLabel: 'Bei Timer-Ablauf',
          basePointsLabel: 'Basispunkte',
          firstCorrectBonusLabel: 'Bonus für erste richtige Antwort',
          speedBonusMaxLabel: 'Max. Zeitbonus',
          speedGrowthLabel: 'Wachstum Zeitbonus',
          streakBaseBonusLabel: 'Basisbonus Serie',
          streakGrowthLabel: 'Wachstum Serie',
          streakLimitLabel: 'Serienlimit',
          optionDoNothing: 'Nichts tun',
          optionStartTimer: 'Timer starten',
          optionRevealScore: 'Aufdecken + werten',
          optionRevealNext: 'Aufdecken + nächste',
          optionYes: 'Ja',
          optionNo: 'Nein',
          optionLinear: 'Linear',
          optionExponential: 'Exponentiell',
          optionLimited: 'Begrenzt',
          waitingForRevealLabel: 'Warten auf Aufdeckung.',
          selectedPathsLabel: 'Ausgewählte Pfade',
          removePathAction: 'Entfernen',
