    ...
    library: {
      ...
      revision: {
        ...
        live: {
          ...
          summaryEvaluationFlow: 'Die Rundenauswertung erfolgt schrittweise: zuerst die Antwortkorrektheit, danach aktive Boni, anschließend wird das Endergebnis als Ganzzahl gespeichert.',
          summaryPointsTotalHint: 'Mit diesen Einstellungen liegt der typische Gewinn pro richtiger Antwort meist im Bereich von etwa {min}–{max} Punkten.',
          ...
          summaryActions: 'Aktion nach erster Antwort: {firstAction}. Aktion nach allen Antworten: {allAction}. Aktion bei Timer-Ende: {expireAction}.',
