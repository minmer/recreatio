    ...
    library: {
      ...
      revision: {
        ...
        live: {
          ...
          summaryBonusTimerDetail: 'Der Bonus-Timer ist {state}. Start: {start}. Der Zeitbonus kann zu Beginn bis zu {startBonus} Punkte geben, nach {midOneSeconds}s etwa {midOneBonus}, nach {midTwoSeconds}s etwa {midTwoBonus} und nach {endSeconds}s 0 Punkte.',
