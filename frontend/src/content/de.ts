...
export const de: Copy = {
  ...
  events: {
    slideTitle: 'Spezielle Ereignisse',
    slideSubtitle: 'Eigene Event-Bereiche mit Ablauf, praktischen Infos und dedizierten Unterseiten.',
    title: 'Spezielle Ereignisse',
    subtitle: 'Jedes Ereignis hat eine eigene URL und Unterseiten, weiterhin auf der REcreatio-Basis.',
    chooserTitle: 'Ereignis auswählen',
    chooserSubtitle: 'Die Liste ist aktuell fest hinterlegt und kann später aus dem Backend kommen.',
    pagesLabel: 'Ereignis-Unterseiten',
  ...
  limanowa: {
    ...
    slideSubtitle: 'Ein zukunftiges Portal mit Stadt- und Regionalinformationen sowie Freizeithinweisen.',
    title: 'Limanowa und Umgebung',
  ...
  calendar: {
    ...
    subtitle: 'Ihr personlicher und Team-Kalender — Monats-, Wochen-, Tages-, Listen-, Zeitstrahl- und Jahresansicht. Verwalten Sie Termine, Aufgaben und Fristen fur sich und Ihr Team.',
    loginCta: 'Anmelden, um den Kalender zu offnen',
    roadmapTitle: 'Funktionsumfang',
    examplesTitle: 'Anwendungsbeispiele',
    note: 'Melden Sie sich an und gehen Sie zu Konto, um eine Rolle zu erstellen — der Kalender richtet sich dann automatisch ein.',
    items: [
  ...
  cogita: {
    ...
    roleIntro: {
      ...
      roles: {
        ...
        explore: {
          ...
          subtitle: 'Entdecke alles, was Cogita zu bieten hat — auf eigene Verantwortung.'
        }
      }
    },
    libraryTemplates: {
    ...
    user: {
      ...
      librariesSubtitle: 'Erstelle eine Bibliotheksrolle und betrete sie, um verschlüsselte Wissenseinträge und Verbindungen zu verwalten.',
      ...
      openCards: 'Wissenseinträge öffnen',
    ...
    workspace: {
      ...
      targets: {
        ...
        allCards: 'Wissenseinträge',
        newCard: 'Neuer Begriff',
      ...
      sidebar: {
        ...
        infoActionsHint: 'Aktionen für Wissenseinträge',
        selectedInfoActionsHint: 'Aktionen des gewählten Begriffs',
        collectionActionsHint: 'Sammlungsaktionen',
        revisionParticipantSessionsHint: 'Live-Sitzungen',
    ...
    core: {
      home: {
        title: 'Cogita Wiederholungs-Runtime',
        subtitle: 'Kanonische Wiederholungs-Runtime mit kompatibler Legacy-Workspace-Anbindung während der Migration.',
        libraryIdLabel: 'Bibliotheks-ID',
        runIdLabel: 'Vorhandene Run-ID',
        idPlaceholder: '00000000-0000-0000-0000-000000000000',
        startNewRunAction: 'Neue Wiederholung starten',
        openRunAction: 'Vorhandenen Run öffnen'
      },
      run: {
        kicker: 'Cogita Wiederholungs-Runtime',
        defaultRunTitle: 'Run',
        generatedRunTitle: 'Wiederholungs-Run',
        defaultParticipantName: 'Teilnehmer',
        scopeLabel: 'Bereich',
        statusLabel: 'Status',
        participantLabel: 'Teilnehmer',
        returnToRecreatio: 'Zurück zu REcreatio',
        backToCogita: 'Zurück zur Runtime-Startseite',
        loading: 'Wiederholungs-Run wird geladen...',
        initFailed: 'Wiederholungs-Run konnte nicht initialisiert werden.',
    ...
    library: {
      ...
      actions: {
        ...
        libraryOverview: 'Bibliotheksübersicht',
        openList: 'Wissenseinträge öffnen',
        collections: 'Sammlungen',
        addInfo: 'Neuen Begriff hinzufügen',
      ...
      overview: {
        kicker: 'Bibliothek',
        subtitle: 'Übersicht deiner verschlüsselten Begriff-Bibliothek.',
        stats: {
          totalInfos: 'Gesamt-Wissenseinträge',
        ...
        quickActionsText: 'Zu Wissenseinträgen wechseln, um zu durchsuchen oder einen neuen Eintrag hinzuzufügen.',
        browseList: 'Liste öffnen',
        viewCollections: 'Sammlungen ansehen',
        addInfo: 'Begriff hinzufügen',
        ...
        focusBody1: 'Jeder Begriff ist verschlüsselt und über Beziehungen verknüpft.',
        ...
        importStageInfos: 'Wissenseinträge',
        importStageConnections: 'Verknüpfungen',
        importStageCollections: 'Sammlungen',
        importLiveProgress: '{stage}: {done}/{total} (Wissenseinträge {infos}, Verknüpfungen {connections}, Sammlungen {collections})',
        importSummary: 'Importiert: {infos} Wissenseinträge, {connections} Verknüpfungen, {collections} Sammlungen.',
      ...
      modules: {
        ...
        storyboardsEditor: {
          ...
          idMissing: 'Storyboard-ID fehlt.',
          createdStatus: 'Storyboard erstellt. Im Bearbeitungsmodus geöffnet.',
          savedStatus: 'Storyboard gespeichert.',
          invalidLinkStatus: 'Ungültiges Link-Ziel oder Link-Quelle.',
          selfLinkStatus: 'Selbstverlinkungen sind nicht erlaubt.',
          startIncomingStatus: 'Startknoten darf keine eingehenden Links haben.',
          endOutgoingStatus: 'Endknoten darf keine ausgehenden Links haben.',
          creatingAction: 'Erstelle...',
          savingAction: 'Storyboard wird gespeichert...',
          saveAction: 'Storyboard speichern',
          runAction: 'Storyboard starten',
          shareWorking: 'Wird ausgeführt...',
          shareCreateAction: 'Geteilten Link erstellen',
          shareCopyAction: 'Geteilten Link kopieren',
          shareRevokeAction: 'Geteilten Link widerrufen',
          descriptionLabel: 'Beschreibung',
          descriptionPlaceholder: 'Storyboard-Beschreibung',
          rootGraphAction: 'Root-Graph',
          addStaticAction: 'Statisch hinzufügen',
          addCardAction: 'Karte hinzufügen',
          addGroupAction: 'Gruppe hinzufügen',
          deleteNodeAction: 'Knoten löschen',
          deleteLinkAction: 'Link löschen',
          nodeTitleLabel: 'Knotentitel',
          nodeDescriptionLabel: 'Knotenbeschreibung',
          staticTypeLabel: 'Statischer Typ',
          staticBodyLabel: 'Statischer Inhalt',
          mediaUrlLabel: 'Medien-URL',
          selectedNotionLabel: 'Begriff',
          selectNotionAction: 'Begriff auswählen',
          checkcardsLoading: 'Prüfkarten werden geladen...',
          checkcardsLoadFailed: 'Prüfkarten konnten nicht geladen werden.',
          checkcardsEmpty: 'Keine Prüfkarten mit diesem Begriff verknüpft.',
          selectCheckingcardHint: 'Prüfkarte auswählen (Richtung).',
          overlaySearchLabel: 'Begriff suchen',
          overlaySearchPlaceholder: 'Mindestens 2 Zeichen eingeben',
          overlaySearching: 'Suche läuft...',
          overlayNoLinkedCheckcards: 'Keine Wissenseinträge mit verknüpften Prüfkarten gefunden.',
          overlayResultCardsSuffix: 'Karten',
          notionIdLabel: 'Begriff-ID',
          directionLabel: 'Richtung',
          enterGroupAction: 'Gruppen-Graph öffnen',
          structuralNodeHelp: 'Struktureller Knoten ({kind}) wird automatisch verwaltet und kann nicht gelöscht werden.',
          linkLabelLabel: 'Link-Beschriftung',
          linkLabelPlaceholder: 'Button-Beschriftung',
          displayModeLabel: 'Anzeigemodus',
          displayModeNewScreen: 'Neuer Bildschirm',
          displayModeExpand: 'Nach unten erweitern',
          displayModeFixedHelp: 'Karten-/Abhängigkeitslinks wechseln immer direkt.',
          inspectorEmpty: 'Wähle einen Knoten zum Bearbeiten. Wähle einen Link zum Löschen.',
          overviewNoDescription: 'Keine Beschreibung.',
          overviewNodes: 'Knoten',
          overviewLinks: 'Links',
          overviewStatic: 'Statisch',
          overviewCards: 'Karten',
          overviewGroups: 'Gruppen',
          overviewStaticBreakdown: 'Text / Video / Audio / Bild / Sonstiges',
          sharedLinkLabel: 'Geteilter Link',
          sharedLinkEmpty: 'Noch kein geteilter Link erstellt.',
          shareUpdateError: 'Geteilter Link konnte nicht aktualisiert werden.',
          shareCopied: 'Geteilter Link kopiert.',
          shareCopyError: 'Geteilter Link konnte nicht kopiert werden.',
          staticTypeText: 'Text',
          staticTypeVideo: 'Video',
          staticTypeAudio: 'Audio',
          staticTypeImage: 'Bild',
          staticTypeOther: 'Sonstiges',
          cardDirectionFrontToBack: 'Vorne -> Hinten',
          cardDirectionBackToFront: 'Hinten -> Vorne',
          nodeKindStatic: 'Statisch',
          nodeKindCard: 'Karte',
          nodeKindGroup: 'Gruppenlogik',
          nodeKindStart: 'Startknoten',
          nodeKindEnd: 'Endknoten',
          edgeKindDependency: 'Abhängigkeit',
          edgeKindRight: 'Richtig',
          edgeKindWrong: 'Falsch'
        },
        storyboardsRuntime: {
          statusMissingParams: 'Storyboard-Routenparameter fehlen.',
          statusNotFound: 'Storyboard nicht gefunden.',
          statusLoadFailed: 'Storyboard-Runtime konnte nicht geladen werden.',
          statusLoadSharedFailed: 'Geteilte Storyboard-Runtime konnte nicht geladen werden.',
          choiceFallback: 'Weiter',
          backAction: 'Zurück zum Storyboard',
          kicker: 'Storyboard-Runtime',
          titleFallback: 'Storyboard',
          restartAction: 'Neu starten',
          loading: 'Runtime wird geladen...',
          blockUntitled: 'Ohne Titel',
          openMediaAction: 'Medium öffnen',
          notionLabel: 'Begriff',
          notionNotSet: 'nicht gesetzt',
          directionLabel: 'Richtung',
          directionFrontToBack: 'Vorne -> Hinten',
          directionBackToFront: 'Hinten -> Vorne',
          cardCheckTypeLabel: 'Prüftyp',
          cardLoading: 'Prüfkarte wird geladen...',
          cardPromptLabel: 'Frage',
          cardAnswerLabel: 'Deine Antwort',
      ...
      statistics: {
        ...
        hideParticipant: '{name} ausblenden',
        showParticipant: '{name} anzeigen',
        openSlide: 'Statistikfolie {index} öffnen',
        modules: {
          scoreLineTitle: 'Punktediagramm',
          scoreLineSubtitle: 'Zeitverlauf der kumulierten Punkte je Teilnehmer.',
          knownessWordsTitle: 'Knowness-Wörter',
          knownessWordsSubtitle: 'Beste und schwächste bekannte Wörter im aktuellen Bereich.',
          knownessLineTitle: 'Knowness-Diagramm',
          knownessLineSubtitle: 'Zeitlicher Knowness-Trend je Teilnehmer.',
          roundScoreGainTitle: 'Rundenpunkt-Zuwachs',
          roundScoreGainSubtitle: 'Punktegewinn pro Runde und Teilnehmer.',
          responseTimeComparisonTitle: 'Antwortzeit-Vergleich',
          responseTimeComparisonSubtitle: 'Durchschnittliche Antwortzeit je Teilnehmer.',
          responseTimePyramidTitle: 'Antwortzeit-Pyramide',
          responseTimePyramidSubtitle: 'Gesamtzeit-Aufteilung je Teilnehmer: korrekt vs falsch.',
          responseTimeSplitTitle: 'Korrekt vs falsch Antwortzeit',
          responseTimeSplitSubtitle: 'Aufteilung der durchschnittlichen Zeit pro korrekter und falscher Antwort.',
          barChartTitle: 'Balkendiagramm',
          barChartSubtitle: 'Gesamtpunkte je Teilnehmer.',
          pyramidRankingTitle: 'Pyramiden-Ranking',
          pyramidRankingSubtitle: 'Durchschnittspunkte pro korrekter Antwort, aufgeteilt in Basis- und Bonusanteile.',
          numberedMetricsTitle: 'Kennzahlen',
          numberedMetricsSubtitle: 'Wichtige Kennzahlen aus dem aktuellen Bereich.'
        }
      },
      list: {
        kicker: 'Bibliotheksliste',
        subtitle: 'Alle verschlüsselten Wissenseinträge durchsuchen.',
        searchTitle: 'Suche',
        searchPlaceholder: 'Suche nach Text, Name oder Label',
        cardCount: '{shown} von {total} Einträgen',
        cardTypeInfo: 'Begriff',
        ...
        selectedTitle: 'Ausgewählter Begriff',
        selectedEmpty: 'Begriff auswählen',
        selectedHint: 'Nutze die Hinzufügen-Seite, um Verknüpfungen oder Vokabeln zu erstellen.',
        noMatch: 'Keine passenden Wissenseinträge gefunden.',
        addInfo: 'Begriff hinzufügen',
        loadMore: 'Mehr laden',
        loading: 'Lädt...',
        ready: 'Bereit',
        ...
        searchOnlyHint: 'Diese Seite dient nur zum Suchen und Auswählen von Wissenseinträgen.',
        typeLabel: 'Begriff-Typ',
        ...
        openSelectedDisabled: 'Wähle einen Begriff zum Öffnen',
        ...
        selectedStackHint: 'Ausgewählte Wissenseinträge bleiben bei Suchänderungen erhalten.',
      ...
      add: {
        kicker: 'Begriff hinzufügen',
        subtitle: 'Neue Wissenseinträge, Verknüpfungen oder Vokabeln erstellen.',
        tabs: {
          info: 'info',
        ...
        tabDesc: {
          ...
          connection: 'Zwei oder mehr Wissenseinträge mit einer Beziehung verbinden.',
        ...
        info: {
          ...
          save: 'Begriff speichern',
          update: 'Änderungen speichern',
          saved: 'Begriff gespeichert.',
          updated: 'Begriff aktualisiert.',
          failed: 'Begriff konnte nicht gespeichert werden.'
        },
        connection: {
          ...
          referencedInfoTypeLabel: 'Begriff-Typ',
          referencedInfoLabel: 'Begriff',
          referencedInfoPlaceholder: 'Begriff suchen oder erstellen',
          workLabel: 'Werk',
          ...
          selectReference: 'Wähle einen Begriff und eine Quelle.',
      ...
      collections: {
        ...
        listSubtitle: 'Kuratierten Begriff-Sets für Wiederholung.',
        ...
        detailSubtitle: 'Kuratierten Begriff-Sets für Wiederholung.',
        noCards: 'Noch keine Einträge in dieser Sammlung.',
        detailFocusTitle: 'Wiederholungen vorbereiten',
        detailFocusBody: 'Erstelle Sammlungen aus Wörtern, Übersetzungen oder beliebigen Wissenseinträgen.',
        deleteConfirm: 'Diese Sammlung löschen? Dieser Vorgang kann nicht rückgängig gemacht werden.',
        deleteFail: 'Sammlung konnte nicht gelöscht werden.',
        createKicker: 'Neue Sammlung',
        createSubtitle: 'Wissenseinträge für fokussiertes Lernen bündeln.',
        ...
        findCardsTitle: 'Wissenseinträge finden',
        searchCardsPlaceholder: 'Wissenseinträge suchen',
        addToCollection: 'Zur Sammlung hinzufügen',
        added: 'Hinzugefügt',
        selectedCardsTitle: 'Ausgewählte Wissenseinträge',
        selectedCountLabel: '{count} Einträge',
        noSelected: 'Noch keine Wissenseinträge ausgewählt.',
        remove: 'Entfernen',
        loading: 'Lädt...',
        ready: 'Bereit'
      },
      revision: {
        ...
        modeDescriptionRandom: 'Der Modus „Zufällige Teilmenge“ erstellt jeden Durchlauf als eigene Sitzung: Aus dem aktuell verfügbaren Kartenpool (nach Filtern und Abhängigkeitsregeln) wird eine begrenzte Auswahl gezogen und zufällig sortiert. Dadurch bleibt jede Sitzung abwechslungsreich und weniger vorhersehbar, was für kurze, regelmäßige Trainings besonders hilfreich ist. Trotz zufälliger Auswahl werden Fortschritt und Bekanntheit nach jeder Antwort gespeichert, sodass spätere Sitzungen auf realen Lerndaten aufbauen.',
        modeDescriptionRandomOnce: 'Der Modus „Voller Stapel (jede Karte einmal)“ lädt den gesamten verfügbaren Pool, mischt ihn und zeigt jede Karte genau einmal pro Durchlauf. So erhältst du eine vollständige Abdeckung ohne Wiederholungen innerhalb derselben Sitzung. Dieser Modus eignet sich besonders für komplette Durchgänge vor Prüfungen, Meilensteinen oder Wochenabschlüssen, wenn nichts ausgelassen werden soll.',
        modeDescriptionLevels: 'Der Stufenmodus arbeitet mit einem aktiven Kartenstapel und passt die Häufigkeit dynamisch an: Gut beantwortete Karten steigen auf und erscheinen seltener, unsichere Karten fallen zurück und werden häufiger wiederholt. Dadurch entsteht ein adaptiver Lernfluss, der sich laufend auf Schwachstellen konzentriert, ohne bereits gefestigte Inhalte vollständig auszublenden.',
        modeDescriptionTemporal: 'Der Zeitverlaufsmodus priorisiert Karten anhand der zeitlichen Bekanntheitsentwicklung: länger nicht wiederholte, instabile oder historisch schwächere Karten werden früher angezeigt, stabile Karten später. Die aktive Warteschlange wird so aufgebaut, dass Vergessen gezielt reduziert und langfristige Behaltensleistung verbessert wird. Dieser Modus ist optimal für kontinuierliche Wissenspflege über längere Zeiträume.',
        ...
        effectTries: 'Pro Karte sind bis zu {value} eigene Antwortversuche möglich, bevor Hinweis bzw. Musterantwort eingeblendet wird; dadurch kannst du dich innerhalb derselben Karte korrigieren, ohne sofort zur nächsten wechseln zu müssen.',
        effectMinCorrectness: 'Antworten gelten ab {value}% Korrektheit als richtig.',
        effectConsiderDependenciesOn: 'Abhängigkeitsprüfungen sind aktiviert: Eine Karte wird erst dann freigegeben, wenn ihre vorausgesetzten Karten (kleinere Wissenseinheiten, notwendige Zwischenschritte oder Teilfragmente) als ausreichend beherrscht gelten. Das erzwingt eine Lernreihenfolge von Grundlagen zu komplexeren Inhalten und reduziert Fehler durch fehlenden Kontext.',
        ...
        considerDependenciesOn: 'Ja, Abhängigkeiten zwischen Karten berücksichtigen',
        considerDependenciesOff: 'Nein, alle Karten unabhängig von Abhängigkeiten behandeln',
        ...
        live: {
          ...
          classNameLabel: 'Klasse',
          classGroupsLabel: 'Klassen für Teilnehmende',
          classGroupsPlaceholder: 'z. B. Klasse A',
          classGroupsHelp: 'Eine Klasse pro Zeile. Teilnehmende wählen beim Beitritt eine Klasse.',
          ...
          scoreHistoryChartAria: 'Punktverlauf',
          ...
          stopNextQuestionTimerAction: 'Timer für nächste Frage stoppen',
          loading: 'Lädt...',
          ...
          detailLaunchTitle: 'Sitzungsansichten',
          openLoginWallAction: 'Login-Panel öffnen',
          openHostWallAction: 'Host-Panel öffnen',
          openScreenWallAction: 'Öffentlichen Bildschirm öffnen',
          reloginQrAction: 'QR für erneute Anmeldung',
          ...
          groupNameLabel: 'Sitzungsname',
          groupNamePlaceholder: 'z. B. Sitzungs-Kopie',
          groupsListTitle: 'Gespeicherte Sitzungen',
          groupsListEmpty: 'Noch keine gespeicherten Sitzungen.',
          loadGroupAction: 'Sitzung öffnen',
          currentGroupLabel: 'Aktuelle Sitzung',
          saveGroupAction: 'Sitzung speichern',
          groupSavedMessage: 'Sitzung gespeichert.',
          groupSaveError: 'Sitzung konnte nicht gespeichert werden.',
          startNextGroupError: 'Sitzung konnte nicht dupliziert werden.',
          resumeSessionHint: 'Nicht beendete Sitzungen bleiben in der Liste und können jederzeit fortgesetzt werden.',
          newSessionAction: 'Sitzung duplizieren',
          resetSessionAction: 'Sitzung duplizieren',
          ...
          removeParticipantConfirmLabel: 'Teilnehmende Person „{name}“ aus dieser Sitzung entfernen?',
          cardsLeftLabel: 'Verbleibende Karten: {count}',
          preparingCardsLabel: 'Karten werden vorbereitet: {count}',
          preparedCardsLabel: 'Vorbereitete Karten: {count}',
          ...
          roundGainDetailsTitle: 'Rundendetails',
          reviewQuestionsTitle: 'Fragenüberblick',
          previousQuestionAction: 'Vorherige Frage',
          pauseTimerAction: 'Timer pausieren',
          resumeTimerAction: 'Timer fortsetzen',
          switchParticipantAction: 'Teilnehmer wechseln',
          useExistingParticipantAction: 'Bestehenden Teilnehmer verwenden',
          chooseDifferentNameAction: 'Anderen Namen wählen',
          duplicateNameInfoLabel: 'Der Name „{name}” wird bereits verwendet. Wenn du „Bestehenden Teilnehmer verwenden” wählst, übernimmst du dessen aktuellen Punktestand und Sitzungsfortschritt.',
          roundReasonBase: 'für die richtige Antwort',
          roundReasonFirst: 'für die erste richtige Antwort',
          roundReasonSpeed: 'für die Antwort in {seconds}s',
          roundReasonStreak: 'für eine Serie von {count} richtigen Antworten',
          roundReasonWrong: 'Abzug für falsche Antwort',
          roundReasonFirstWrong: 'zusätzlicher Abzug für die erste falsche Antwort',
          roundReasonWrongStreak: 'Fehlerserie von {count} Antworten',
          asyncScoreContextHelp: 'Der Vergleich zeigt die Punkte jeder teilnehmenden Person nach {count} beantworteten Fragen (dein aktueller Stand).',
          bonusExplanation: '✓ Basispunkte für richtige Antwort, ⚡ Bonus für die erste richtige Antwort, ⏱ Tempobonus abhängig von Restzeit, 🔥 Bonus für eine richtige Serie, ✖ Abzug für falsche Antwort.',
          showScoreOverlayAction: 'Punktestand zeigen',
          hideScoreOverlayAction: 'Punktestand ausblenden',
          factorBaseLabel: 'Basis',
          factorFirstLabel: 'Erste richtige Antwort',
          factorSpeedLabel: 'Zeitbonus',
          factorStreakLabel: 'Serienbonus',
          factorWrongLabel: 'Malus bei falscher Antwort',
          factorFirstWrongLabel: 'Malus für erste falsche Antwort',
          factorWrongStreakLabel: 'Malus für Fehlerserie',
          streakLabel: 'Serie',
          onFirstAnswerLabel: 'Bei erster Antwort',
          onAllAnsweredLabel: 'Wenn alle geantwortet haben',
          roundTimerLabel: 'Frage-Timer',
          roundTimerEnabledLabel: 'Frage-Timer aktiv',
          roundTimerSecondsLabel: 'Sekunden des Frage-Timers',
          roundTimerExpireLabel: 'Wenn Frage-Timer endet',
          actionTimerLabel: 'Aktions-Timer',
          timerEnabledLabel: 'Timer aktiv',
          timerSecondsLabel: 'Timer-Sekunden',
          onTimerExpiredLabel: 'Bei Timer-Ablauf',
          nextQuestionBehaviorLabel: 'Nächste Frage',
          nextQuestionModeLabel: 'Wie die nächste Frage angezeigt wird',
          nextQuestionModeManual: 'Manuell (Host-Klick)',
          nextQuestionModeTimer: 'Automatisch nach Timer',
          nextQuestionTimerSecondsLabel: 'Sekunden bis Auto-Weiter',
          nextQuestionTimerLabel: 'Timer bis nächste Frage',
          bonusTimerLabel: 'Bonus-Timer',
          bonusTimerEnabledLabel: 'Bonus-Timer aktiv',
          bonusTimerSecondsLabel: 'Bonus-Timer-Sekunden',
          bonusTimerStartLabel: 'Start des Bonus-Timers',
          bonusTimerStartAfterFirst: 'Nach erster Antwort',
          bonusTimerStartRound: 'Zu Rundenbeginn',
          basePointsLabel: 'Basispunkte',
          firstCorrectBonusLabel: 'Bonus für erste richtige Antwort',
          firstBonusModeLabel: 'Modus für Bonus der ersten Antwort',
          firstBonusModeFirstAnswer: 'Erste Antwort (auch wenn falsch)',
          firstBonusModeFirstCorrect: 'Erste richtige Antwort',
          wrongAnswerPenaltyLabel: 'Malus bei falscher Antwort',
          firstWrongPenaltyLabel: 'Zusatzmalus für die erste falsche Antwort',
          firstWrongPenaltyModeLabel: 'Modus für ersten Falsch-Malus',
          firstWrongPenaltyModeOverallFirst: 'Nur wenn die erste Gesamtantwort falsch war',
          firstWrongPenaltyModeFirstWrong: 'Erste falsche Antwort der Runde',
          speedBonusEnabledLabel: 'Geschwindigkeitsbonus aktiv',
          speedBonusMaxLabel: 'Max. Zeitbonus',
          speedGrowthLabel: 'Wachstum Zeitbonus',
          streakBaseBonusLabel: 'Basisbonus Serie',
          streakBonusEnabledLabel: 'Serienbonus aktiv',
          streakGrowthLabel: 'Wachstum Serie',
          streakLimitLabel: 'Serienlimit',
          wrongStreakPenaltyEnabledLabel: 'Fehlerserien-Malus aktiv',
          wrongStreakBasePenaltyLabel: 'Basis-Malus für Fehlerserie',
          wrongStreakGrowthLabel: 'Wachstum Fehlerserien-Malus',
          wrongStreakLimitLabel: 'Limit Fehlerserie',
          presetLabel: 'Sitzungs-Preset',
          presetBalancedDuel: 'Ausgewogenes Duell',
          presetFirstStrike: 'Erste Antwort entscheidet',
          presetSprintRace: 'Sprint-Rennen',
          presetAccuracyFocus: 'Genauigkeitsfokus',
          presetStreakMaster: 'Serienmeister',
          presetMarathonClassic: 'Klassischer Marathon',
          presetAsyncChallenge: 'Asynchrone Challenge',
          presetCustom: 'Benutzerdefiniert',
          summaryTitle: 'Sitzungsverhalten im Überblick',
          summaryPreset: 'Du verwendest das Preset {preset}. Dieses Preset legt den Grundstil der Live-Sitzung fest. Wenn du einzelne Felder manuell änderst, wechselt die Sitzung automatisch auf „Benutzerdefiniert“, damit klar ist, dass du von der Vorlage abweichst.',
          summaryPoints: 'Basispunkte für eine richtige Antwort: {base} Punkte; Bonus für die erste richtige Antwort: {first} Punkte.',
          ...
          summaryBonusNone: 'In dieser Konfiguration sind Boni deaktiviert: für richtige Antworten werden nur Basispunkte vergeben ({base}).',
          summaryBonusFirst: 'Der Bonus für die erste richtige Antwort ist aktiv und beträgt {first} Punkte.',
          summaryBonusSpeed: 'Der Geschwindigkeitsbonus ist aktiv. Sein Maximum beträgt {max} Punkte und fällt mit der Zeit bis auf null.',
          summaryBonusStreak: 'Der Serienbonus ist aktiv. Er wächst im Modus {growth} und erreicht seine volle Wirkung nach {limit} richtigen Antworten in Folge.',
          summaryWrongPenalty: 'Eine falsch abgegebene Antwort reduziert die Punktzahl um bis zu {penalty} {unit}.',
          summaryFirstWrongPenalty: 'Wenn die erste abgegebene Antwort in einer Runde falsch ist, wird ein zusätzlicher Malus bis zu {penalty} {unit} angewendet.',
          summaryNoWrongPenalty: 'Falsche Antworten reduzieren aktuell keine Punkte.',
          summaryBonusSpeedDisabled: 'Der Geschwindigkeitsbonus ist deaktiviert.',
          summaryBonusStreakDisabled: 'Der Serienbonus ist deaktiviert.',
          summaryEvaluationFlow: 'Die Punkte werden in Reihenfolge berechnet. Zuerst wird die Korrektheit der Antwort geprüft, dann werden aktive Boni angewendet, und das Ergebnis wird als Ganzzahl gespeichert.',
          summaryPointsTotalHint: 'Mit diesen Einstellungen liegt der typische Gewinn für eine richtige Antwort bei etwa {min}–{max} Punkten.',
          summaryStreak: 'Der Serienbonus wächst im Modus {growth} bis maximal {max} Punkte und erreicht die volle Wirkung nach {limit} richtigen Antworten in Folge.',
          summaryActions: 'Rundenablauf: nach der ersten Antwort -> {firstAction}; wenn alle geantwortet haben -> {allAction}; wenn der Aktions-Timer endet -> {expireAction}.',
          summaryTypeLineSync: 'Dies ist eine synchrone Sitzung. Alle Teilnehmenden beantworten dieselben Fragen parallel, und der Host steuert das Tempo.',
          summaryTypeLineAsync: 'Dies ist eine asynchrone Sitzung. Teilnehmende bearbeiten die Runde im eigenen Tempo, die Punkte werden trotzdem gemeinsam verglichen.',
          summaryBasePointsDetailed: 'Basispunkte für eine richtige Antwort sind {base} {unit}.',
          summaryBonusItem: '{label} kann bis zu {value} {unit} geben',
          summaryBonusesList: 'Aktive Boni sind {bonuses}.',
          summaryRangeLine: 'Damit kann eine richtige Antwort zwischen {min} und {max} {unit} geben.',
          summaryBonusesActive: 'Aktive Boni sind {bonuses}. Der maximal zusätzliche Gewinn durch Boni beträgt {maxBonus} Punkte.',
          summaryBonusesNone: 'Boni sind deaktiviert, daher gibt eine richtige Antwort nur Basispunkte.',
          summaryBonusTimerDetail: 'Der Bonus-Timer startet {start}. Zu Beginn kann der Zeitbonus bis zu {startBonus} Punkte geben, nach {midOneSeconds}s etwa {midOneBonus}, nach {midTwoSeconds}s etwa {midTwoBonus} und nach {endSeconds}s fällt er auf 0.',
          summaryBonusTimerDisabled: 'Der Bonus-Timer ist deaktiviert, daher gibt es keinen Zeitbonus.',
          summaryStreakDetail: 'Der Serienbonus im Modus {growth} kann bis zu {max} {unit} geben. Beispielweise gibt Serie {streakOne} etwa {bonusOne} {unit}, Serie {streakTwo} etwa {bonusTwo} {unit} und Serie {streakThree} etwa {bonusThree} {unit}.',
          summaryStreakDisabled: 'Der Serienbonus ist deaktiviert.',
          summaryAllAnsweredDetail: 'Wenn alle Teilnehmenden geantwortet haben, führt die Sitzung die Aktion {allAction} aus.',
          summaryRoundTimerDetail: 'Der Frage-Timer ist für {seconds} s aktiv. Wenn er endet, führt das System {expireAction} aus.',
          summaryRoundTimerDisabled: 'Der Frage-Timer ist deaktiviert, daher endet die Runde nicht automatisch wegen Zeitablauf.',
          summaryNextQuestionManual: 'Nach der Wertung wechselt der Host manuell zur nächsten Frage.',
          summaryNextQuestionTimer: 'Nach der Wertung wechselt die Sitzung nach {seconds} Sekunden automatisch zur nächsten Frage, sofern der Host den Timer nicht stoppt.',
          summaryActionFlowDetail: 'Nach der ersten Antwort führt die Sitzung {firstAction} aus. Wenn alle geantwortet haben, führt sie {allAction} aus. Wenn der Aktions-Timer endet, führt sie {expireAction} aus.',
          summaryActionTimerOnlyDetail: 'Der Aktions-Timer ist aktiv. Nach der ersten Antwort führt das System {firstAction} aus und beim Timerende {expireAction}.',
          summaryActionTimerDisabledDetail: 'Der Aktions-Timer ist deaktiviert, daher gibt es nach der ersten Antwort keine timerbasierte Aktion.',
          bonusUsageLabel: 'Bonus verwenden für',
          bonusUsageAll: 'Alle Boni',
          bonusUsageNone: 'Kein Bonus',
          bonusUsageFirst: 'Nur erste richtige Antwort',
          bonusUsageSpeed: 'Nur Geschwindigkeit',
          bonusUsageStreak: 'Nur Serie',
      ...
      graph: {
        ...
        previewBreakdown: '{connections} Verknüpfungen · {infos} Wissenseinträge',
        ...
        scopeWordA: 'Wort A',
        scopeWordB: 'Wort B',
        infoTypeLabel: 'Begriff-Typ',
        specificInfoLabel: 'Spezifischer Begriff',
        specificInfoPlaceholder: 'Begriff suchen',
  ...
  cg: {
    title: 'Cogita Graph',
    subtitle: 'Vokabellisten, Telefonbücher, strukturierte Lektionen und vieles mehr — mit einem flexiblen Knotengraph-Modell.',
    loginCta: 'Anmelden',
    landing: {
      logo: 'Cogita Graph',
      headline: 'Dein Wissen,',
      headlineAccent: 'als vernetzter Graph',
      sub: 'Erstelle Vokabellisten, Telefonbücher, strukturierte Lektionen und alles dazwischen — mit einem flexiblen Knotengraph-Modell. Jede Information ist verknüpft.',
      features: [
        { icon: '📖', title: 'Vokabular',    desc: 'Zweisprachige Wortpaare in beliebiger Sprachkombination, bereit zur Wiederholung.' },
        { icon: '📇', title: 'Telefonbuch',  desc: 'Kontakte mit mehreren Telefonnummern, E-Mails und Notizen — immer durchsuchbar.' },
        { icon: '🎓', title: 'Lektion',      desc: 'Konzepte, Fragen und Themen, zu einer strukturierten Sitzung verbunden.' },
        { icon: '◉',  title: 'Beliebiger Graph', desc: 'Eigene Knotentypen, Felder und Beziehungen von Grund auf definieren.' },
      ],
      cta: 'Anmelden und starten',
      linkCogita: '← Zurück zu Cogita (klassisch)',
      linkHome: 'REcreatio-Startseite',
    },
    home: {
      title: 'Graph-Bibliotheken',
      sub: 'Jede Bibliothek hat ein eigenes Knotenschema und einen eigenen Graph.',
      newLibrary: '+ Neue Bibliothek',
      wizardTitle: 'Neue Bibliothek',
      nameLabel: 'Name',
      namePlaceholder: 'z. B. Spanisch-Vokabeln, Meine Kontakte…',
      templateLabel: 'Vorlage',
      createAction: 'Bibliothek erstellen',
      creating: 'Wird erstellt…',
      cancel: 'Abbrechen',
      loadFailed: 'Bibliotheken konnten nicht geladen werden',
      createFailed: 'Bibliothek konnte nicht erstellt werden',
      deleteFailed: 'Bibliothek konnte nicht gelöscht werden',
      deleteConfirm: 'Löschen bestätigen',
      deleteCancel: 'Abbrechen',
      emptyTitle: 'Noch keine Bibliotheken.',
      emptyDesc: 'Erstelle eine, um zu starten.',
      templates: {
        vocabulary: { name: 'Vokabular',   desc: 'Zweisprachige Wortpaare in beliebiger Sprachkombination, bereit zur Wiederholung.' },
        phonebook:  { name: 'Telefonbuch', desc: 'Kontakte mit Telefonnummern, E-Mails und Notizen — immer durchsuchbar.' },
        lesson:     { name: 'Lektion',     desc: 'Konzepte, Fragen und Themen, strukturiert für Unterricht oder Studium.' },
        custom:     { name: 'Benutzerdefiniert', desc: 'Mit leerem Schema starten und eigene Knotentypen definieren.' },
      },
      templateLabels: { vocabulary: 'Vokabular', phonebook: 'Telefonbuch', lesson: 'Lektion', custom: 'Benutzerdefiniert' },
      backToCogita: '← Cogita (klassisch)',
    },
    library: {
      kicker: { vocabulary: 'Vokabular-Bibliothek', phonebook: 'Telefonbuch-Bibliothek', lesson: 'Lektions-Bibliothek', custom: 'Benutzerdefinierte Bibliothek' },
      ...
      fields: 'Felder',
      nodes: 'Knoten',
      browseNodes: '▶ Knoten durchsuchen',
      editSchema: '✎ Schema bearbeiten',
      schemaPreview: 'Schemavorschau',
      noFields: 'Keine Felder definiert',
      subentity: 'Untereinheit',
      goTo: 'Gehe zu',
    ...
    studio: {
      title: 'Schema-Editor',
      sub: 'Knotentypen und ihre Felder definieren. Das erste Feld wird als Anzeige-Label verwendet.',
      ...
      addTypeTitle: 'Knotentyp hinzufügen',
      typeName: 'Typname',
      typePlaceholder: 'z. B. Person, Wortpaar…',
      isSubentity: 'Untereinheit',
      addTypeAction: 'Typ hinzufügen',
      addingType: 'Wird hinzugefügt…',
      noFields: 'Noch keine Felder. Unten hinzufügen.',
      deleteType: 'Typ löschen',
      addTypeFailed: 'Knotentyp konnte nicht hinzugefügt werden',
      addFieldFailed: 'Feld konnte nicht hinzugefügt werden',
    ...
    graph: {
      title: 'Knoten',
      searchPlaceholder: 'Nach Label suchen…',
      allTypes: 'Alle Typen',
      addNode: 'Knoten hinzufügen',
      labelPlaceholder: 'Label',
      addAction: '+ Hinzufügen',
      adding: 'Wird hinzugefügt…',
      loadFailed: 'Knoten konnten nicht geladen werden',
      createFailed: 'Knoten konnte nicht erstellt werden',
      deleteFailed: 'Knoten konnte nicht gelöscht werden',
      labelColumn: 'Label',
      typeColumn: 'Typ',
      noNodes: 'Noch keine Knoten.',
      noNodesDesc: 'Füge oben den ersten hinzu.',
    },
    node: {
      backAction: '← Zurück',
      labelSection: 'Label',
      ...
      noLabel: '(kein Label — klicken zum Setzen)',
      saveAction: 'Speichern',
      cancelAction: 'Abbrechen',
      saveFailed: 'Label konnte nicht gespeichert werden',
      fieldSaveFailed: 'Feld konnte nicht gespeichert werden',
      deleteValueFailed: 'Wert konnte nicht gelöscht werden',
      multi: '(Mehrfach)',
      outgoing: '→',
      incoming: '←',
      created: 'Erstellt:',
