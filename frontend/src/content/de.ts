    ...
    library: {
      ...
      revision: {
        ...
        live: {
          ...
          summaryPreset: '{preset}: Dieses Preset legt den Grundstil der Live-Sitzung fest. Wenn du einzelne Felder manuell änderst, wechselt die Sitzung automatisch auf „Benutzerdefiniert“, damit klar ist, dass du von der Vorlage abweichst.',
          ...
          summaryEvaluationFlow: 'Die Punkte werden in Reihenfolge berechnet: zuerst die Korrektheit der Antwort, dann aktive Boni; das Ergebnis wird als Ganzzahl gespeichert.',
          ...
          summaryBasePointsDetailed: 'Basispunkte für eine richtige Antwort: {base} {unit}.',
          summaryBonusItem: '{label}: bis zu {value} {unit}',
          summaryBonusesList: 'Aktive Boni: {bonuses}.',
          summaryRangeLine: 'Damit kann eine richtige Antwort zwischen {min} und {max} {unit} geben.',
          summaryBonusesActive: 'Aktive Boni: {bonuses}. Der maximal zusätzliche Gewinn durch Boni beträgt {maxBonus} Punkte.',
          ...
          summaryStreakDetail: 'Serienbonus ({growth}) kann bis zu {max} {unit} geben. Beispiel: Serie {streakOne} -> {bonusOne} {unit}, Serie {streakTwo} -> {bonusTwo} {unit}, Serie {streakThree} -> {bonusThree} {unit}.',
          summaryStreakDisabled: 'Der Serienbonus ist deaktiviert.',
          summaryAllAnsweredDetail: 'Wenn alle Teilnehmenden geantwortet haben: {allAction}.',
          summaryRoundTimerDetail: 'Der Frage-Timer ist für {seconds} s aktiv. Wenn er endet, führt das System aus: {expireAction}.',
          summaryRoundTimerDisabled: 'Der Frage-Timer ist deaktiviert, daher endet die Runde nicht automatisch wegen Zeitablauf.',
          summaryActionFlowDetail: 'Der Aktions-Timer ist {timerState}. Nach der ersten Antwort: {firstAction}. Wenn alle geantwortet haben: {allAction}. Wenn der Aktions-Timer endet: {expireAction}.',
