...
export const de: Copy = {
  ...
  account: {
    ...
    persons: {
      ...
      lookupLabel: 'Per Login suchen',
      lookupPlaceholder: 'Login-ID eingeben',
      lookupAction: 'Rolle suchen',
      lookupWorking: 'Rolle wird gesucht…',
      lookupSuccess: 'Rolle gefunden.',
      lookupError: 'Rolle nicht gefunden.',
      lookupMissing: 'Login-ID ist erforderlich.',
