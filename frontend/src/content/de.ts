...
export const de: Copy = {
  ...
  account: {
    ...
    persons: {
      lead: 'Lege Personenrollen für die Nutzer dieses Kontos an. Jede Person hat eigene verschlüsselte Felder und eine Zugriffsliste.',
      addToggle: 'Person hinzufügen',
      nameLabel: 'Name',
      namePlaceholder: 'Name oder Bezeichnung',
      descriptionLabel: 'Beschreibung',
      descriptionPlaceholder: 'Beziehung oder Rollenhinweis',
      ...
      createMissing: 'Name und Beschreibung sind erforderlich.',
      ...
      accessEmpty: 'Keine Mitglieder.',
      memberTitle: 'Mitglied hinzufügen',
      memberLoginLabel: 'Login-ID',
      memberLoginPlaceholder: 'Login-ID eingeben',
      memberKeyLabel: 'Verschlüsselter Rollen-Schlüssel (Base64)',
      memberKeyPlaceholder: 'Verschlüsselte Schlüsselkopie einfügen',
      memberTypeLabel: 'Zugriffsrolle',
      memberAction: 'Zugriff hinzufügen',
      memberWorking: 'Mitglied wird hinzugefügt…',
      memberSuccess: 'Mitglied hinzugefügt.',
      memberError: 'Mitglied konnte nicht hinzugefügt werden.',
      memberMissing: 'Login-ID und verschlüsselter Schlüssel sind erforderlich.',
      memberRolesLabel: 'Weitere Rollen',
      memberRolesEmpty: 'Keine Rollen',
