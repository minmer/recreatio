...
export const de: Copy = {
  ...
  account: {
    ...
    roles: {
      ...
      relationAdminOf: 'AdminOf — Mitglieder und Einstellungen verwalten.',
      relationWrite: 'Write — Daten bearbeiten, keine Mitgliedschaft.',
      relationRead: 'Read — nur lesen.',
      relationMemberOf: 'MemberOf — Mitgliedschaft.',
      relationDelegatedTo: 'DelegatedTo — delegierte Befugnis.',
      relationData: 'Data — verschlüsseltes Rollenfeld.',
      relationRecoveryOwner: 'RecoveryOwner — Rolle besitzt Wiederherstellungsschlüssel.',
      relationRecoveryShare: 'RecoveryShare — geteilte Wiederherstellung.',
      relationRecoveryAccess: 'RecoveryAccess — Rolle kann wiederherstellen.',
      viewGraph: 'Graph',
      viewDetails: 'Details',
