    ...
    library: {
      ...
      sidebar: {
        ...
        groups: {
          ...
          libraryStats: 'Statistiken',
          libraryTransfers: 'Transfers',
          librarySecurity: 'Sicherheit',
          cardsBrowse: 'Durchsuchen',
          cardsAdd: 'Hinzufügen',
          cardsTypes: 'Typen',
          collectionsManage: 'Verwalten',
          collectionsTemplates: 'Vorlagen',
          collectionsRevision: 'Wiederholung',
          currentOverview: 'Übersicht',
          currentRevision: 'Wiederholung',
          currentInsights: 'Einblicke',
        ...
        items: {
          ...
          libraryStats: 'Bibliotheksstatistik',
          libraryRoles: 'Rollengraph',
          libraryTransfers: 'Export & Import',
          librarySecurity: 'Sicherheit & Schlüssel',
          typeVocab: 'Vokabelkarten',
          typeLanguage: 'Sprachen',
          typeWord: 'Wörter',
          typeSentence: 'Sätze / Zitate',
          typeTopic: 'Themen',
          typePerson: 'Personen',
          typeAddress: 'Adressen',
          typeEmail: 'E-Mails',
          typePhone: 'Telefone',
          typeBook: 'Bücher',
          typeMedia: 'Medien',
          typeGeo: 'Geodaten',
          typeMusic: 'Musik',
          typeComputed: 'Berechnet',
          collections: 'Alle Sammlungen',
          createCollection: 'Sammlung erstellen',
          smartCollections: 'Smarte Sammlungen',
          dependencyRules: 'Abhängigkeitsregeln',
          revisionQueue: 'Wiederholungswarteschlange',
          revisionHistory: 'Wiederholungsverlauf',
          ...
          collectionStats: 'Sammlungsstatistik',
          collectionKnowness: 'Wissenskarte',
          collectionExport: 'Sammlung exportieren'
        },
        badges: {
          comingSoon: 'Bald'
        }
      ...
      add: {
        ...
        group: {
          ...
          citationSourceLabelLabel: 'Quellenlabel',
          citationSourceLabelPlaceholder: 'Name oder Kennung der Quelle',
          citationSourceKindLabel: 'Quellentyp',
          citationChurchTitleLabel: 'Titel des Kirchendokuments',
          citationChurchTitlePlaceholder: 'Vollständiger Titel des Dokuments',
          citationChurchShortcutLabel: 'Kirchendokument-Kürzel',
          citationChurchShortcutPlaceholder: 'Kurzer Referenzname',
          citationChurchAuthorTypeLabel: 'Autorentyp',
          citationChurchAuthorLabel: 'Autor',
          citationChurchAuthorPlaceholder: 'Autor suchen oder erstellen',
          citationWorkTitleLabel: 'Werktitel',
          citationWorkTitlePlaceholder: 'Titel des Werks',
          citationBookTitleLabel: 'Buchtitel',
          citationBookTitlePlaceholder: 'Titel des Buchs/der Ausgabe',
