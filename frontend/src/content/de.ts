    ...
    library: {
      ...
      add: {
        ...
        info: {
          ...
          referencesPlaceholder: 'Referenzen suchen oder erstellen',
          ...
          referenceSourceLabel: 'Quelle',
          referenceSourcePlaceholder: 'Quelle suchen oder erstellen',
          referenceLocatorTypeLabel: 'Locator-Typ',
          referenceLocatorTypePlaceholder: 'Locator-Typ auswählen',
          referenceLocatorValueLabel: 'Locator',
          referenceLocatorValuePlaceholder: 'Seite, Zeitcode, Abschnitt, Vers oder URL-Fragment',
