...
export const RC_OFFICE_HOURS = [
  { day: 'Poniedziałek', hours: '9:00 – 11:00' },
  { day: 'Wtorek', hours: '16:00 – 18:00' },
  { day: 'Środa', hours: 'nieczynne' },
  { day: 'Czwartek', hours: '9:00 – 11:00' },
  { day: 'Piątek', hours: '16:00 – 18:00' }
] as const;

/**
 * Die Sakramentenseiten.
 *
 * Alle tragen dieselbe Form: was mitzubringen ist, an wen man sich wendet, wie
 * lange es dauert. Das ist keine Vereinfachung — es ist die Frage, mit der
 * jemand kommt, und die Antwort steht sonst in drei Absätzen Fliesstext.
 */
export const RC_SACRAMENTS: Record<string, {
  title: string;
  lead: string;
  ...
  'sacrament-baptism': {
    title: 'Chrzest',
    lead: 'Chrzty w drugą i czwartą niedzielę miesiąca podczas Mszy o 11:00.',
    bring: ['Akt urodzenia dziecka', 'Dane rodziców chrzestnych', 'Zaświadczenia chrzestnych z ich parafii'],
    who: 'Kancelaria parafialna, najpóźniej dwa tygodnie wcześniej.'
  },
  'sacrament-communion': {
    title: 'I Komunia Święta',
    lead: 'Przygotowanie trwa cały rok szkolny i obejmuje spotkania dla dzieci i rodziców.',
    bring: ['Świadectwo chrztu dziecka', 'Zgłoszenie u katechety'],
    who: 'ks. Adam Kowalski'
  },
  'sacrament-confirmation': {
    title: 'Bierzmowanie',
    lead: 'Formacja obejmuje spotkania w grupach, celebracje i posługę we wspólnocie.',
    bring: ['Świadectwo chrztu', 'Zgoda rodziców dla niepełnoletnich'],
    who: 'ks. Marek Nowak'
  },
  'sacrament-marriage': {
    title: 'Małżeństwo',
    lead: 'Zgłoszenie najpóźniej trzy miesiące przed planowaną datą.',
    bring: ['Świadectwa chrztu z adnotacją', 'Zaświadczenie z USC', 'Świadectwo katechezy'],
    who: 'Kancelaria parafialna'
  },
  'sacrament-funeral': {
    title: 'Pogrzeb',
    lead: 'W sprawach pogrzebu prosimy o kontakt o każdej porze.',
    bring: ['Akt zgonu', 'Zaświadczenie o sakramentach, jeśli zmarły mieszkał poza parafią'],
    who: 'Telefon dyżurny parafii'
  },
  'sacrament-sick': {
    title: 'Sakrament chorych',
    lead: 'Odwiedziny chorych w pierwsze piątki miesiąca od 9:00.',
    bring: ['Zgłoszenie w kancelarii lub telefonicznie'],
    who: 'ks. Paweł Zieliński'
  }
};
